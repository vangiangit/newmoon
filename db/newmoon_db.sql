...
CREATE TABLE `fs_album`  (
  ...
  `category_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `source_website` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `created_time` datetime NULL DEFAULT NULL,
  `updated_time` datetime NULL DEFAULT NULL,
  `editor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `show_in_homepage` tinyint(4) NULL DEFAULT NULL,
  ...
  `total_images` tinyint(4) NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for fs_album_categories
-- ----------------------------
DROP TABLE IF EXISTS `fs_album_categories`;
CREATE TABLE `fs_album_categories`  (
  ...
  `name_display` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `is_comment` tinyint(4) NOT NULL,
  `notice` tinyint(4) NULL DEFAULT 0 COMMENT 'Danh mục tin thông báo',
  `seo_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `seo_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `seo_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lang` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'vi',
...
-- ----------------------------
-- Records of fs_album_categories
-- ----------------------------
INSERT INTO `fs_album_categories` VALUES (1, 'Album ảnh', 'album-anh', NULL, ',album-anh,', 0, ',1,', 0, 1, 1, NULL, NULL, '2018-08-27 12:01:31', '2018-08-27 12:01:31', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '', 'vi');

-- ----------------------------
-- Table structure for fs_album_images
-- ----------------------------
DROP TABLE IF EXISTS `fs_album_images`;
CREATE TABLE `fs_album_images`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `record_id` int(11) NOT NULL,
  `tmp` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of fs_album_images
-- ----------------------------

-- ----------------------------
-- Table structure for fs_backgrounds
-- ----------------------------
DROP TABLE IF EXISTS `fs_backgrounds`;
CREATE TABLE `fs_backgrounds`  (
  ...
  `background_color` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `repeat_x` tinyint(4) NULL DEFAULT NULL,
  `repeat_y` tinyint(4) NULL DEFAULT NULL,
  `published` tinyint(4) NOT NULL DEFAULT 1,
...
CREATE TABLE `fs_banners`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `type` int(4) NULL DEFAULT NULL COMMENT '0: images/flash; 1: content',
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `edited_time` datetime NULL DEFAULT NULL,
  `published` tinyint(4) NULL DEFAULT NULL,
  `target` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '_blank',
  `ordering` int(11) NULL DEFAULT NULL,
  `lang` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'vi',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `fs_banners` VALUES (1, 1, 'Banner home', 'banner-home', 1, 'images/banners/original/banner-home-1650771832.png', NULL, '', 0, 0, '', 0, '2022-04-24 10:43:52', '2022-04-24 10:43:52', 1, '_blank', 1, 'vi');

-- ----------------------------
-- Table structure for fs_banners_categories
-- ----------------------------
DROP TABLE IF EXISTS `fs_banners_categories`;
...
-- ----------------------------
-- Records of fs_banners_categories
-- ----------------------------
INSERT INTO `fs_banners_categories` VALUES (1, 'Banner home', 1, 1, '2022-04-24 10:43:43', '2022-04-24 10:43:43', 'vi');
...
CREATE TABLE `fs_blocks`  (
  ...
  `listItemid` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `params` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `showTitle` tinyint(4) NULL DEFAULT NULL,
  `products_categories` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `fs_blocks` VALUES (1, 'Menu top', '', 1, 1, 'menu', 'menu-position', 'all', 'suffix=_menu\rgroup=1\rorder_by=default\rstyle=nav\rclass=navbar-nav me-auto mb-lg-0', 0, '', 'all', 'vi');
...
-- ----------------------------
INSERT INTO `fs_blocks_exist` VALUES (7, 'news', 'Danh sách tin', 7, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (12, 'about', 'Giới thiệu', 7, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (5, 'fanbox', 'Facebook', 5, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (4, 'contents', 'Nội dung tĩnh', 4, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (3, 'products', 'Danh sách sản phẩm', 3, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (2, 'categories', 'Danh mục sản phẩm', 2, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (1, 'catsmenu', 'Menu danh mục', 1, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (8, 'banners', 'Quảng cáo', 8, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (9, 'space', 'Dòng trắng', 9, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (11, 'social', 'Social', 10, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (13, 'diet', 'Thực đơn của bạn', 11, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (14, 'fitness', 'Kế hoạch tập luyện', 12, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (15, 'videos', 'Videos', 13, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (16, 'filters', 'Lọc sản phẩm', 14, NULL, 0, '');
INSERT INTO `fs_blocks_exist` VALUES (17, 'menu', 'Menu', 15, NULL, 1, '');
INSERT INTO `fs_blocks_exist` VALUES (18, 'album', 'Album ảnh', 16, NULL, 1, '');
...
-- ----------------------------
INSERT INTO `fs_config_modules` VALUES (24, 'Danh mục sản phẩm', 'products', 'cat', NULL, 1, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_config_modules` VALUES (25, 'Hãng sản xuất', 'products', 'manufactory', NULL, 1, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_config_modules` VALUES (26, 'Chi tiết sản phẩm', 'products', 'product', NULL, 1, NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_config_modules` VALUES (27, 'Loại sản phẩm', 'products', 'types', NULL, 1, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_config_modules` VALUES (28, 'Danh mục tin', 'news', 'cat', NULL, 1, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_config_modules` VALUES (29, 'Chi tiết tin', 'news', 'news', '', 1, NULL, 21, NULL, '1,seo_title|1,title', '1,seo_keyword|2,summary', '1,title|1,summary|2,seo_keyword', 'summary', 'title|summary', '1,title|1,summary|2,seo_title');
INSERT INTO `fs_config_modules` VALUES (30, 'Tìm kiếm tin', 'news', 'search', NULL, 1, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
-- Records of fs_contact
-- ----------------------------

-- ----------------------------
-- Table structure for fs_faqs
-- ----------------------------
DROP TABLE IF EXISTS `fs_faqs`;
...
-- ----------------------------
-- Records of fs_faqs_categories
-- ----------------------------
INSERT INTO `fs_faqs_categories` VALUES (1, 'Câu hỏi thường gặp', 'cau-hoi-thuong-gap', NULL, ',cau-hoi-thuong-gap,', 0, ',1,', 0, 1, 1, NULL, NULL, '2018-04-30 23:06:14', '2018-04-30 23:06:14', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '');
...
CREATE TABLE `fs_groups`  (
  ...
  `updated_time` datetime NULL DEFAULT NULL,
  `edit_other` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `fs_groups` VALUES (1, 'Super Admin', 'full permission', 1, 1, '2015-02-26 07:10:35', 1, '2015-02-26 07:10:35', 0);
...
CREATE TABLE `fs_groups_permission`  (
  ...
  `module_type_id` int(11) NULL DEFAULT NULL,
  `permission` int(4) NULL DEFAULT NULL COMMENT '3: view\r\n5: edit\r\n7: delete',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 145 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
INSERT INTO `fs_groups_permission` VALUES (33, 1, 1, 3);
...
INSERT INTO `fs_groups_permission` VALUES (134, 1, 5, 0);
INSERT INTO `fs_groups_permission` VALUES (135, 1, 6, 0);
INSERT INTO `fs_groups_permission` VALUES (136, 1, 7, 0);
INSERT INTO `fs_groups_permission` VALUES (137, 1, 8, 0);
INSERT INTO `fs_groups_permission` VALUES (138, 1, 11, 0);
INSERT INTO `fs_groups_permission` VALUES (139, 1, 13, 0);
INSERT INTO `fs_groups_permission` VALUES (140, 1, 15, 0);
INSERT INTO `fs_groups_permission` VALUES (141, 1, 16, 0);
INSERT INTO `fs_groups_permission` VALUES (142, 1, 17, 0);
INSERT INTO `fs_groups_permission` VALUES (143, 1, 22, 0);
INSERT INTO `fs_groups_permission` VALUES (144, 1, 23, 0);
...
-- ----------------------------
INSERT INTO `fs_languages` VALUES (1, 'Việt Nam', 'vi', 1);
...
-- ----------------------------
INSERT INTO `fs_languages_tables` VALUES (3, 'fs_menus_items', 1, 'Menu', 'name', '0000-00-00 00:00:00', 1, ',alias,target,link,template,list_parent,', NULL, NULL, NULL, NULL);
INSERT INTO `fs_languages_tables` VALUES (11, 'fs_news', 3, 'Tin tức', 'title', NULL, 1, ',category_alias,category_name,category_id_wrapper,category_alias_wrapper,editor,creator,source_website,alias,', NULL, NULL, NULL, NULL);
INSERT INTO `fs_languages_tables` VALUES (12, 'fs_news_categories', 2, 'Danh mục tin tức', 'name', NULL, 1, ',alias_wrapper,list_parents,icon,parent_id,alias,', ',list_parents,', 'alias_wrapper=>list_parents|generate_alias_wrapper;\r\n', NULL, 'category_alias=>alias|fs_news||id|category_id;');
INSERT INTO `fs_languages_tables` VALUES (13, 'fs_products_categories', 4, 'Danh mục sản phẩm', 'name', NULL, 1, ',category_alias,category_name,category_id_wrapper,category_alias_wrapper,editor,creator,source_website,alias,', NULL, 'alias_wrapper=>list_parents|generate_alias_wrapper;', NULL, 'category_alias=>alias|fs_products||id|category_id;');
INSERT INTO `fs_languages_tables` VALUES (14, 'fs_products', 5, 'Sản phẩm', 'name', NULL, 1, ',category_alias,category_name,category_id_wrapper,category_alias_wrapper,category_root_alias,editor,creator,discount_unit,currency,color,size,origin,tags,code,alias,', NULL, NULL, NULL, NULL);
...
CREATE TABLE `fs_languages_text`  (
  ...
  `lang_jp` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fs_languages_text_admin` VALUES (1, 'Languages', 'Ngôn ngữ', 'Languages', '', 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (2, 'Configuration', 'Cấu hình', 'Configuration', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (3, 'Banner', 'Quảng cáo', 'Banner', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (4, 'Contact', 'Liên hệ', 'Contact', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (5, 'Translate phrases (backend)', 'Ngôn ngữ admin', 'Translate phrases (backend)', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (6, 'Translate phrases (font-end)', 'Ngôn ngữ website', 'Translate phrases (font-end)', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (7, 'Translate content', 'Dịch nội dung', 'Translate content', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (8, 'Synchronize', 'Đồng bộ nội dung', 'Synchronize', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (9, 'summary', 'Mô tả', 'Description', NULL, 1, NULL, 1);
INSERT INTO `fs_languages_text_admin` VALUES (10, 'Thành viên quản trị', 'Thành viên quản trị', 'Users manager', NULL, 1, NULL, 1);

-- ----------------------------
-- Table structure for fs_local_cities
-- ----------------------------
DROP TABLE IF EXISTS `fs_local_cities`;
CREATE TABLE `fs_local_cities`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `country_id` int(11) NULL DEFAULT NULL,
  `regions_id` int(11) NULL DEFAULT 1,
...
-- ----------------------------
-- Records of fs_local_cities
-- ----------------------------
INSERT INTO `fs_local_cities` VALUES (1, 66, 1, NULL, 'Hà Nội', 40000, 1, 1);
INSERT INTO `fs_local_cities` VALUES (3, 66, 1, NULL, 'Hải Phòng', 40000, 4, 1);
INSERT INTO `fs_local_cities` VALUES (4, 66, 1, NULL, 'Bắc Giang', 40000, 10, 1);
INSERT INTO `fs_local_cities` VALUES (5, 66, 1, NULL, 'Bắc Kạn', 40000, 9, 1);
INSERT INTO `fs_local_cities` VALUES (6, 66, 1, NULL, 'Bắc Ninh', 40000, 11, 1);
INSERT INTO `fs_local_cities` VALUES (7, 66, 1, NULL, 'Cao Bằng', 40000, 18, 1);
INSERT INTO `fs_local_cities` VALUES (8, 66, 1, NULL, 'Điện Biên', 40000, 23, 1);
INSERT INTO `fs_local_cities` VALUES (9, 66, 1, NULL, 'Hà Giang', 40000, 25, 1);
INSERT INTO `fs_local_cities` VALUES (10, 66, 1, NULL, 'Hà Nam', 40000, 26, 1);
INSERT INTO `fs_local_cities` VALUES (11, 66, 1, NULL, 'Hải Dương', 40000, 28, 1);
INSERT INTO `fs_local_cities` VALUES (12, 66, 1, NULL, 'Hòa Bình', 40000, 29, 1);
INSERT INTO `fs_local_cities` VALUES (13, 66, 1, NULL, 'Hưng Yên', 40000, 31, 1);
INSERT INTO `fs_local_cities` VALUES (14, 66, 1, NULL, 'Lai Châu', 40000, 35, 1);
INSERT INTO `fs_local_cities` VALUES (15, 66, 1, NULL, 'Lạng Sơn', 40000, 37, 1);
INSERT INTO `fs_local_cities` VALUES (16, 66, 1, NULL, 'Lào Cai', 40000, 36, 1);
INSERT INTO `fs_local_cities` VALUES (17, 66, 1, NULL, 'Nam Định', 40000, 40, 1);
INSERT INTO `fs_local_cities` VALUES (18, 66, 1, NULL, 'Ninh Bình', 40000, 42, 1);
INSERT INTO `fs_local_cities` VALUES (19, 66, 1, NULL, 'Phú Thọ', 40000, 44, 1);
INSERT INTO `fs_local_cities` VALUES (20, 66, 1, NULL, 'Quảng Ninh', 40000, 49, 1);
INSERT INTO `fs_local_cities` VALUES (21, 66, 1, NULL, 'Sơn La', 40000, 52, 1);
INSERT INTO `fs_local_cities` VALUES (22, 66, 1, NULL, 'Thái Bình', 40000, 54, 1);
INSERT INTO `fs_local_cities` VALUES (23, 66, 1, NULL, 'Thái Nguyên', 40000, 55, 1);
INSERT INTO `fs_local_cities` VALUES (24, 66, 1, NULL, 'Thanh Hóa', 40000, 56, 1);
INSERT INTO `fs_local_cities` VALUES (25, 66, 1, NULL, 'Tuyên Quang', 40000, 60, 1);
INSERT INTO `fs_local_cities` VALUES (26, 66, 1, NULL, 'Vĩnh Phúc', 40000, 62, 1);
INSERT INTO `fs_local_cities` VALUES (27, 66, 1, NULL, 'Yên Bái', 40000, 63, 1);
INSERT INTO `fs_local_cities` VALUES (28, 66, 2, NULL, 'Đà Nẵng', 40000, 3, 1);
INSERT INTO `fs_local_cities` VALUES (29, 66, 2, NULL, 'Bình Định', 40000, 14, 1);
INSERT INTO `fs_local_cities` VALUES (30, 66, 2, NULL, 'Bình Phước', 40000, 15, 1);
INSERT INTO `fs_local_cities` VALUES (31, 66, 2, NULL, 'Bình Thuận', 40000, 16, 1);
INSERT INTO `fs_local_cities` VALUES (32, 66, 2, NULL, 'Đắk Lắk', 40000, 19, 1);
INSERT INTO `fs_local_cities` VALUES (33, 66, 2, NULL, 'Đắk Nông', 40000, 20, 1);
INSERT INTO `fs_local_cities` VALUES (34, 66, 2, NULL, 'Gia Lai', 40000, 24, 1);
INSERT INTO `fs_local_cities` VALUES (35, 66, 2, NULL, 'Hà Tĩnh', 40000, 27, 1);
INSERT INTO `fs_local_cities` VALUES (36, 66, 2, NULL, 'Khánh Hòa', 40000, 32, 1);
INSERT INTO `fs_local_cities` VALUES (37, 66, 2, NULL, 'Kon Tum', 40000, 34, 1);
INSERT INTO `fs_local_cities` VALUES (38, 66, 2, NULL, 'Lâm Đồng', 40000, 38, 1);
INSERT INTO `fs_local_cities` VALUES (39, 66, 2, NULL, 'Nghệ An', 40000, 41, 1);
INSERT INTO `fs_local_cities` VALUES (40, 66, 2, NULL, 'Ninh Thuận', 40000, 43, 1);
INSERT INTO `fs_local_cities` VALUES (41, 66, 2, NULL, 'Phú Yên', 40000, 45, 1);
INSERT INTO `fs_local_cities` VALUES (42, 66, 2, NULL, 'Quảng Bình', 40000, 46, 1);
INSERT INTO `fs_local_cities` VALUES (43, 66, 2, NULL, 'Quảng Nam', 40000, 47, 1);
INSERT INTO `fs_local_cities` VALUES (44, 66, 2, NULL, 'Quảng Ngãi', 40000, 48, 1);
INSERT INTO `fs_local_cities` VALUES (45, 66, 3, NULL, 'Cà Mau', 40000, 1, 1);
INSERT INTO `fs_local_cities` VALUES (46, 66, 3, NULL, 'Bạc Liêu', 40000, 2, 1);
INSERT INTO `fs_local_cities` VALUES (47, 66, 3, NULL, 'Sóc Trăng', 40000, 3, 1);
INSERT INTO `fs_local_cities` VALUES (48, 66, 3, NULL, 'Đồng Tháp', 40000, 4, 1);
INSERT INTO `fs_local_cities` VALUES (49, 66, 3, NULL, 'Bà Rịa - Vũng Tàu', 40000, 5, 1);
INSERT INTO `fs_local_cities` VALUES (50, 66, 3, NULL, 'Kiên Giang', 40000, 6, 1);
INSERT INTO `fs_local_cities` VALUES (51, 66, 3, NULL, 'Hậu Giang', 40000, 7, 1);
INSERT INTO `fs_local_cities` VALUES (52, 66, 3, NULL, 'Trà Vinh', 40000, 8, 1);
INSERT INTO `fs_local_cities` VALUES (53, 66, 3, NULL, 'Vĩnh Long', 40000, 9, 1);
INSERT INTO `fs_local_cities` VALUES (54, 66, 3, NULL, 'Bến Tre', 40000, 10, 1);
INSERT INTO `fs_local_cities` VALUES (55, 66, 3, NULL, 'Tiền Giang', 40000, 11, 1);
INSERT INTO `fs_local_cities` VALUES (56, 66, 3, NULL, 'An Giang', 40000, 12, 1);
INSERT INTO `fs_local_cities` VALUES (57, 66, 3, NULL, 'Bình Phước', 40000, 13, 1);
INSERT INTO `fs_local_cities` VALUES (58, 66, 3, NULL, 'Tây Ninh', 40000, 14, 1);
INSERT INTO `fs_local_cities` VALUES (59, 66, 3, NULL, 'Cần Thơ', 40000, 15, 1);
INSERT INTO `fs_local_cities` VALUES (60, 66, 3, NULL, 'Long An', 40000, 16, 1);
INSERT INTO `fs_local_cities` VALUES (61, 66, 3, NULL, 'Đồng Nai', 40000, 17, 1);
INSERT INTO `fs_local_cities` VALUES (62, 66, 3, NULL, 'Bình Dương', 40000, 18, 1);
INSERT INTO `fs_local_cities` VALUES (63, 66, 3, NULL, 'Hồ Chí Minh', 40000, 19, 1);

-- ----------------------------
-- Table structure for fs_local_countries
-- ----------------------------
DROP TABLE IF EXISTS `fs_local_countries`;
CREATE TABLE `fs_local_countries`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sort_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `flag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'flag',
...
-- ----------------------------
-- Records of fs_local_countries
-- ----------------------------
INSERT INTO `fs_local_countries` VALUES (1, 'Thụy Sĩ', 'thuy-si', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (2, 'Anh', 'anh', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (3, 'Hà Lan', 'ha-lan', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (4, 'Mexico', 'mexico', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (5, 'Morocco', 'morocco', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (6, 'Đan Mạch', 'dan-mach', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (7, 'Tây Ban Nha', 'tay-ban-nha', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (8, 'Đức', 'duc', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (9, 'Ba Lan', 'ba-lan', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (10, 'Italia', 'italia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (11, 'Czech', 'czech', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (12, 'Brazil', 'brazil', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (13, 'Wales', 'wales', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (14, 'Cameroon', 'cameroon', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (15, 'Nga', 'nga', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (16, 'Bờ Biển Ngà', 'bo-bien-nga', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (17, 'Ghana', 'ghana', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (18, 'Ireland', 'ireland', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (19, 'Senegal', 'senegal', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (20, 'Mỹ', 'my', NULL, 'images/countries/original/usa_1349063791.jpg', 0, 1, NULL, '2012-10-01 11:56:31');
INSERT INTO `fs_local_countries` VALUES (21, 'Australia', 'australia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (22, 'Bulgaria', 'bulgaria', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (23, 'Scotland', 'scotland', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (24, 'Thụy Điển', 'thuy-dien', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (25, 'Congo', 'congo', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (26, 'New Zealand', 'new-zealand', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (27, 'Croatia', 'croatia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (28, 'Zimbabwe', 'zimbabwe', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (29, 'Canada', 'canada', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (30, 'Grenada', 'grenada', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (31, 'Argentina', 'argentina', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (32, 'Nauy', 'nauy', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (33, 'Algeria', 'algeria', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (34, 'Iceland', 'iceland', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (35, 'Hungary', 'hungary', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (36, 'Phần Lan', 'phan-lan', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (37, 'Oman', 'oman', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (38, 'Jamaica', 'jamaica', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (39, 'Hàn Quốc', 'han-quoc', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (40, 'Serbia', 'serbia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (41, 'Bồ Đào Nha', 'bo-dao-nha', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (42, 'Israel', 'israel', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (43, 'Nigeria', 'nigeria', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (44, 'Hy Lạp', 'hy-lap', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (45, 'Slovakia', 'slovakia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (46, 'Bắc Ireland', 'bac-ireland', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (47, 'Uruguay', 'uruguay', NULL, 'images/countries/original/uruguay_1349064075.jpg', 0, 1, NULL, '2012-10-01 12:01:15');
INSERT INTO `fs_local_countries` VALUES (48, 'Togo', 'togo', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (49, 'Bosnia and Herzegovina', 'bosnia-and-herzegovina', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (50, 'Paraguay', 'paraguay', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (51, 'Ecuador', 'ecuador', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (52, 'Colombia', 'colombia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (53, 'Đảo Faroe', 'dao-faroe', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (54, 'Slovenia', 'slovenia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (55, 'Latvia', 'latvia', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (56, 'Trinidad and Tobago', 'trinidad-and-tobago', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (57, 'Mali', 'mali', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (58, 'Ai Cập', 'ai-cap', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (59, 'Benin', 'benin', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (60, 'Nam Phi', 'nam-phi', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (61, 'Honduras', 'honduras', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (62, 'Romania', 'romania', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (63, 'Chile', 'chile', NULL, NULL, 0, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (64, 'Barbados', 'barbados', NULL, NULL, 3, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (65, 'Guadeloupe', 'guadeloupe', NULL, NULL, 2, 1, NULL, NULL);
INSERT INTO `fs_local_countries` VALUES (66, 'Việt Nam', 'viet-nam', NULL, 'images/countries/original/vietnam-flag_1349065079.gif', 1, 1, NULL, '2012-10-01 12:17:59');
INSERT INTO `fs_local_countries` VALUES (67, 'Trung Quốc', 'trung-quoc', NULL, 'images/countries/original/China_1349063823.gif', 4, 1, '2012-07-24 10:28:57', '2012-10-01 11:57:22');

-- ----------------------------
-- Table structure for fs_local_districts
-- ----------------------------
DROP TABLE IF EXISTS `fs_local_districts`;
...
-- ----------------------------
-- Records of fs_local_districts
-- ----------------------------
INSERT INTO `fs_local_districts` VALUES (1, NULL, 1, 'Q.Hoàn Kiếm', 1, 1);
INSERT INTO `fs_local_districts` VALUES (2, NULL, 1, 'Q.Ba Đình', 2, 1);
INSERT INTO `fs_local_districts` VALUES (3, NULL, 1, 'Q.Đống Đa ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (4, NULL, 1, 'Q.Hai Bà Trưng', 6, 1);
INSERT INTO `fs_local_districts` VALUES (5, NULL, 1, 'Q.Thanh Xuân ', 7, 1);
INSERT INTO `fs_local_districts` VALUES (6, NULL, 1, 'Q.Tây Hồ', 5, 1);
INSERT INTO `fs_local_districts` VALUES (7, NULL, 1, 'Q.Cầu Giấy', 3, 1);
INSERT INTO `fs_local_districts` VALUES (8, NULL, 1, 'Q.Hoàng Mai', 10, 1);
INSERT INTO `fs_local_districts` VALUES (9, NULL, 1, 'Q.Long Biên', 8, 1);
INSERT INTO `fs_local_districts` VALUES (10, NULL, 1, 'H.Đông Anh', 13, 1);
INSERT INTO `fs_local_districts` VALUES (11, NULL, 1, 'H.Gia Lâm', 15, 1);
INSERT INTO `fs_local_districts` VALUES (12, NULL, 1, 'H.Sóc Sơn', 16, 1);
INSERT INTO `fs_local_districts` VALUES (13, NULL, 1, 'H.Thanh Trì', 9, 1);
INSERT INTO `fs_local_districts` VALUES (14, NULL, 1, 'H.Từ Liêm', 15, 1);
INSERT INTO `fs_local_districts` VALUES (15, NULL, 1, 'Q.Hà Đông', 11, 1);
INSERT INTO `fs_local_districts` VALUES (16, NULL, 1, 'TX.Sơn Tây', 13, 1);
INSERT INTO `fs_local_districts` VALUES (17, NULL, 1, 'H.Mê Linh', 21, 1);
INSERT INTO `fs_local_districts` VALUES (18, NULL, 1, 'H.Ba Vì', 19, 1);
INSERT INTO `fs_local_districts` VALUES (19, NULL, 1, 'H.Phúc Thọ', 24, 1);
INSERT INTO `fs_local_districts` VALUES (20, NULL, 1, 'H.Đan Phượng', 29, 1);
INSERT INTO `fs_local_districts` VALUES (21, NULL, 1, 'H.Hoài Đức', 20, 1);
INSERT INTO `fs_local_districts` VALUES (22, NULL, 1, 'H.Quốc Oai', 17, 1);
INSERT INTO `fs_local_districts` VALUES (23, NULL, 1, 'H.Thạch Thất', 25, 1);
INSERT INTO `fs_local_districts` VALUES (24, NULL, 1, 'H.Chương Mỹ', 18, 1);
INSERT INTO `fs_local_districts` VALUES (25, NULL, 1, 'H.Thanh Oai', 26, 1);
INSERT INTO `fs_local_districts` VALUES (26, NULL, 1, 'H.Thường Tín', 27, 1);
INSERT INTO `fs_local_districts` VALUES (27, NULL, 1, 'H.Phú Xuyên', 23, 1);
INSERT INTO `fs_local_districts` VALUES (28, NULL, 1, 'H.Ứng Hòa', 28, 1);
INSERT INTO `fs_local_districts` VALUES (29, NULL, 1, 'H.Mỹ Đức', 22, 1);
INSERT INTO `fs_local_districts` VALUES (30, NULL, 2, 'Quận 1', 3, 1);
INSERT INTO `fs_local_districts` VALUES (31, NULL, 2, 'Quận 2', 4, 1);
INSERT INTO `fs_local_districts` VALUES (32, NULL, 2, 'Quận 3', 3, 1);
INSERT INTO `fs_local_districts` VALUES (33, NULL, 2, 'Quận 4', 4, 1);
INSERT INTO `fs_local_districts` VALUES (34, NULL, 2, 'Quận 5', 5, 1);
INSERT INTO `fs_local_districts` VALUES (35, NULL, 2, 'Quận 6', 6, 1);
INSERT INTO `fs_local_districts` VALUES (36, NULL, 2, 'Quận 7', 7, 1);
INSERT INTO `fs_local_districts` VALUES (37, NULL, 2, 'Quận 8', 8, 1);
INSERT INTO `fs_local_districts` VALUES (38, NULL, 2, 'Quận 9', 9, 1);
INSERT INTO `fs_local_districts` VALUES (39, NULL, 2, 'Quận 10', 11, 1);
INSERT INTO `fs_local_districts` VALUES (40, NULL, 2, 'Quận 11', 11, 1);
INSERT INTO `fs_local_districts` VALUES (41, NULL, 2, 'Quận 12', 12, 1);
INSERT INTO `fs_local_districts` VALUES (42, NULL, 2, 'Quận Bình Tân', 13, 1);
INSERT INTO `fs_local_districts` VALUES (43, NULL, 2, 'Quận Bình Thạnh', 14, 1);
INSERT INTO `fs_local_districts` VALUES (44, NULL, 2, 'Quận Gò Vấp', 15, 1);
INSERT INTO `fs_local_districts` VALUES (45, NULL, 2, 'Quận Phú Nhuận', 16, 1);
INSERT INTO `fs_local_districts` VALUES (46, NULL, 2, 'Quận Tân Bình', 17, 1);
INSERT INTO `fs_local_districts` VALUES (47, NULL, 2, 'Quận Tân Phú', 18, 1);
INSERT INTO `fs_local_districts` VALUES (48, NULL, 2, 'Quận Thủ Đức', 19, 1);
INSERT INTO `fs_local_districts` VALUES (49, NULL, 2, 'H.Bình Chánh', 20, 1);
INSERT INTO `fs_local_districts` VALUES (50, NULL, 2, 'H.Cần Giờ', 21, 1);
INSERT INTO `fs_local_districts` VALUES (51, NULL, 2, 'H.Củ Chi', 22, 1);
INSERT INTO `fs_local_districts` VALUES (52, NULL, 2, 'H.Hóc Môn', 23, 1);
INSERT INTO `fs_local_districts` VALUES (53, NULL, 2, 'H.Nhà Bè', 24, 1);
INSERT INTO `fs_local_districts` VALUES (54, NULL, 3, 'H.An Lão', 9, 1);
INSERT INTO `fs_local_districts` VALUES (55, NULL, 3, 'Q.Đồ Sơn', 0, 1);
INSERT INTO `fs_local_districts` VALUES (56, NULL, 3, 'Q.Dương Kinh', 0, 1);
INSERT INTO `fs_local_districts` VALUES (57, NULL, 3, 'Q.Hải An', 0, 1);
INSERT INTO `fs_local_districts` VALUES (58, NULL, 3, 'Q.Hồng Bàng', 0, 1);
INSERT INTO `fs_local_districts` VALUES (59, NULL, 3, 'Q.Kiến An', 0, 1);
INSERT INTO `fs_local_districts` VALUES (60, NULL, 3, 'Q.Lê Chân', 0, 1);
INSERT INTO `fs_local_districts` VALUES (61, NULL, 3, 'Q.Ngô Quyền', 0, 1);
INSERT INTO `fs_local_districts` VALUES (62, NULL, 3, 'H.An Dương', 8, 1);
INSERT INTO `fs_local_districts` VALUES (63, NULL, 3, 'H.Bạch Long Vĩ', 15, 1);
INSERT INTO `fs_local_districts` VALUES (64, NULL, 3, 'H.Cát Hải', 10, 1);
INSERT INTO `fs_local_districts` VALUES (65, NULL, 3, 'H.Kiến Thụy', 11, 1);
INSERT INTO `fs_local_districts` VALUES (66, NULL, 3, 'H.Thủy Nguyên', 12, 1);
INSERT INTO `fs_local_districts` VALUES (67, NULL, 3, 'H.Tiên Lãng', 13, 1);
INSERT INTO `fs_local_districts` VALUES (68, NULL, 3, 'H.Vĩnh Bảo', 14, 1);
INSERT INTO `fs_local_districts` VALUES (69, NULL, 4, 'H.Tân Yên', 7, 1);
INSERT INTO `fs_local_districts` VALUES (70, NULL, 4, 'H.Việt Yên', 8, 1);
INSERT INTO `fs_local_districts` VALUES (71, NULL, 4, 'H.Yên Dũng', 9, 1);
INSERT INTO `fs_local_districts` VALUES (72, NULL, 4, 'H.Yên Thế', 10, 1);
INSERT INTO `fs_local_districts` VALUES (73, NULL, 4, 'TP.Bắc Giang', 1, 1);
INSERT INTO `fs_local_districts` VALUES (74, NULL, 4, 'H.Hiệp Hòa', 2, 1);
INSERT INTO `fs_local_districts` VALUES (75, NULL, 4, 'H.Lạng Giang', 3, 1);
INSERT INTO `fs_local_districts` VALUES (76, NULL, 4, 'H.Lục Nam', 4, 1);
INSERT INTO `fs_local_districts` VALUES (77, NULL, 4, 'H.Lục Ngạn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (78, NULL, 4, 'H.Sơn Động', 6, 1);
INSERT INTO `fs_local_districts` VALUES (79, NULL, 5, 'H.Pac Nặm', 8, 1);
INSERT INTO `fs_local_districts` VALUES (80, NULL, 5, 'H.Ba Bể', 2, 1);
INSERT INTO `fs_local_districts` VALUES (81, NULL, 5, 'H.Bạch Thông', 3, 1);
INSERT INTO `fs_local_districts` VALUES (82, NULL, 5, 'H.Chợ Đồn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (83, NULL, 5, 'H.Na Rì', 6, 1);
INSERT INTO `fs_local_districts` VALUES (84, NULL, 5, 'H.Ngân Sơn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (85, NULL, 5, 'H.Chợ Mới', 4, 1);
INSERT INTO `fs_local_districts` VALUES (86, NULL, 5, 'TX.Bắc Kạn', 1, 1);
INSERT INTO `fs_local_districts` VALUES (87, NULL, 6, 'H.Lương Tài', 3, 1);
INSERT INTO `fs_local_districts` VALUES (88, NULL, 6, 'H.Quế Võ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (89, NULL, 6, 'H.Thuận Thành', 5, 1);
INSERT INTO `fs_local_districts` VALUES (90, NULL, 6, 'H.Tiên Du', 6, 1);
INSERT INTO `fs_local_districts` VALUES (91, NULL, 6, 'H.Từ Sơn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (92, NULL, 6, 'H.Yên Phong', 8, 1);
INSERT INTO `fs_local_districts` VALUES (93, NULL, 6, 'TP.Bắc Ninh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (94, NULL, 6, 'H.Gia Bình', 2, 1);
INSERT INTO `fs_local_districts` VALUES (95, NULL, 7, 'TX.Cao Bằng', 1, 1);
INSERT INTO `fs_local_districts` VALUES (96, NULL, 7, 'H.Bảo Lạc', 2, 1);
INSERT INTO `fs_local_districts` VALUES (97, NULL, 7, 'H.Hạ Lang', 3, 1);
INSERT INTO `fs_local_districts` VALUES (98, NULL, 7, 'H.Hà Quảng', 4, 1);
INSERT INTO `fs_local_districts` VALUES (99, NULL, 7, 'H.Hòa An', 5, 1);
INSERT INTO `fs_local_districts` VALUES (100, NULL, 7, 'H.Nguyên Bình', 6, 1);
INSERT INTO `fs_local_districts` VALUES (101, NULL, 7, 'H.Quảng Hòa', 7, 1);
INSERT INTO `fs_local_districts` VALUES (102, NULL, 7, 'H.Thạch An', 8, 1);
INSERT INTO `fs_local_districts` VALUES (103, NULL, 7, 'H.Thông Nông', 9, 1);
INSERT INTO `fs_local_districts` VALUES (104, NULL, 7, 'H.Trà Lĩnh', 10, 1);
INSERT INTO `fs_local_districts` VALUES (105, NULL, 7, 'H.Trùng Khánh', 11, 1);
INSERT INTO `fs_local_districts` VALUES (106, NULL, 8, 'TP. Điện Biên Phủ', 1, 1);
INSERT INTO `fs_local_districts` VALUES (107, NULL, 8, 'TX.Lai Châu', 2, 1);
INSERT INTO `fs_local_districts` VALUES (108, NULL, 8, 'H.Mường Nhé', 5, 1);
INSERT INTO `fs_local_districts` VALUES (109, NULL, 8, 'H.Điện Biên', 8, 1);
INSERT INTO `fs_local_districts` VALUES (110, NULL, 8, 'H. Điện Biên Đông', 3, 1);
INSERT INTO `fs_local_districts` VALUES (111, NULL, 8, 'H.Tuần Giáo', 7, 1);
INSERT INTO `fs_local_districts` VALUES (112, NULL, 8, 'H.Tủa Chùa', 6, 1);
INSERT INTO `fs_local_districts` VALUES (113, NULL, 8, 'H.Mường Lay', 4, 1);
INSERT INTO `fs_local_districts` VALUES (114, NULL, 9, 'TX.Hà Giang', 1, 1);
INSERT INTO `fs_local_districts` VALUES (115, NULL, 9, 'H.Quang Bình', 7, 1);
INSERT INTO `fs_local_districts` VALUES (116, NULL, 9, 'H.Bắc Quang', 3, 1);
INSERT INTO `fs_local_districts` VALUES (117, NULL, 9, 'H.Mèo Vạc ', 5, 1);
INSERT INTO `fs_local_districts` VALUES (118, NULL, 9, 'H.Bắc Mê', 2, 1);
INSERT INTO `fs_local_districts` VALUES (119, NULL, 9, 'H.Đồng Văn', 10, 1);
INSERT INTO `fs_local_districts` VALUES (120, NULL, 9, 'H.Hoàng Su Phì', 4, 1);
INSERT INTO `fs_local_districts` VALUES (121, NULL, 9, 'H.Quản Bạ', 6, 1);
INSERT INTO `fs_local_districts` VALUES (122, NULL, 9, 'H.Vị Xuyên', 8, 1);
INSERT INTO `fs_local_districts` VALUES (123, NULL, 9, 'H.Xí Mần', 9, 1);
INSERT INTO `fs_local_districts` VALUES (124, NULL, 10, 'H.Lý Nhân', 5, 1);
INSERT INTO `fs_local_districts` VALUES (125, NULL, 10, 'TP.Phủ Lý', 1, 1);
INSERT INTO `fs_local_districts` VALUES (126, NULL, 10, 'H.Lục Bình', 4, 1);
INSERT INTO `fs_local_districts` VALUES (127, NULL, 10, 'H.Duy Tiên', 2, 1);
INSERT INTO `fs_local_districts` VALUES (128, NULL, 10, 'H.Kim Bảng', 3, 1);
INSERT INTO `fs_local_districts` VALUES (129, NULL, 10, 'H.Thanh Liêm', 6, 1);
INSERT INTO `fs_local_districts` VALUES (130, NULL, 11, 'H.Bình Giang', 3, 1);
INSERT INTO `fs_local_districts` VALUES (131, NULL, 11, 'H.Cẩm Giàng', 4, 1);
INSERT INTO `fs_local_districts` VALUES (132, NULL, 11, 'TX. Chí Linh', 2, 1);
INSERT INTO `fs_local_districts` VALUES (133, NULL, 11, 'H.Kim Thành', 6, 1);
INSERT INTO `fs_local_districts` VALUES (134, NULL, 11, 'H.Kinh Môn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (135, NULL, 11, 'H.Thanh Hà', 10, 1);
INSERT INTO `fs_local_districts` VALUES (136, NULL, 11, 'H.Thanh Miện', 11, 1);
INSERT INTO `fs_local_districts` VALUES (137, NULL, 11, 'H.Tứ Kỳ', 12, 1);
INSERT INTO `fs_local_districts` VALUES (138, NULL, 11, 'TP.Hải Dương', 1, 1);
INSERT INTO `fs_local_districts` VALUES (139, NULL, 11, 'H.Gia Lộc', 5, 1);
INSERT INTO `fs_local_districts` VALUES (140, NULL, 11, 'H.Nam Sách', 8, 1);
INSERT INTO `fs_local_districts` VALUES (141, NULL, 11, 'H.Ninh Giang', 9, 1);
INSERT INTO `fs_local_districts` VALUES (142, NULL, 12, 'H.Kim Bôi', 3, 1);
INSERT INTO `fs_local_districts` VALUES (143, NULL, 12, 'H.Kỳ Sơn', 4, 1);
INSERT INTO `fs_local_districts` VALUES (144, NULL, 12, 'H.Lương Sơn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (145, NULL, 12, 'TP.Hoà Bình', 1, 1);
INSERT INTO `fs_local_districts` VALUES (146, NULL, 12, 'H.Cao Phong', 2, 1);
INSERT INTO `fs_local_districts` VALUES (147, NULL, 12, 'H.Đà Bắc', 11, 1);
INSERT INTO `fs_local_districts` VALUES (148, NULL, 12, 'H.Lạc Sơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (149, NULL, 12, 'H.Lạc Thủy', 6, 1);
INSERT INTO `fs_local_districts` VALUES (150, NULL, 12, 'H.Mai Châu', 8, 1);
INSERT INTO `fs_local_districts` VALUES (151, NULL, 12, 'H.Tân Lạc', 9, 1);
INSERT INTO `fs_local_districts` VALUES (152, NULL, 12, 'H.Yên Thủy', 10, 1);
INSERT INTO `fs_local_districts` VALUES (153, NULL, 13, 'H.Khoái Châu', 3, 1);
INSERT INTO `fs_local_districts` VALUES (154, NULL, 13, 'H.Mỹ Hào ', 5, 1);
INSERT INTO `fs_local_districts` VALUES (155, NULL, 13, 'H.Phù Cừ ', 6, 1);
INSERT INTO `fs_local_districts` VALUES (156, NULL, 13, 'H.Văn Giang', 8, 1);
INSERT INTO `fs_local_districts` VALUES (157, NULL, 13, 'H.Văn Lâm', 9, 1);
INSERT INTO `fs_local_districts` VALUES (158, NULL, 13, 'H.Yên Mỹ', 10, 1);
INSERT INTO `fs_local_districts` VALUES (159, NULL, 13, 'TP.Hưng Yên', 1, 1);
INSERT INTO `fs_local_districts` VALUES (160, NULL, 13, 'H.Ân Thi', 2, 1);
INSERT INTO `fs_local_districts` VALUES (161, NULL, 13, 'H.Kim Động', 4, 1);
INSERT INTO `fs_local_districts` VALUES (162, NULL, 13, 'H.Tiên Lữ', 7, 1);
INSERT INTO `fs_local_districts` VALUES (163, NULL, 14, 'TX.Lai Châu', 1, 1);
INSERT INTO `fs_local_districts` VALUES (164, NULL, 14, 'H.Mường Tè', 2, 1);
INSERT INTO `fs_local_districts` VALUES (165, NULL, 14, 'H.Phong Thổ', 3, 1);
INSERT INTO `fs_local_districts` VALUES (166, NULL, 14, 'H.Sìn Hồ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (167, NULL, 14, 'H.Tam Đường', 5, 1);
INSERT INTO `fs_local_districts` VALUES (168, NULL, 14, 'H.Than Uyên', 7, 1);
INSERT INTO `fs_local_districts` VALUES (169, NULL, 14, 'H.Tân Uyên', 6, 1);
INSERT INTO `fs_local_districts` VALUES (170, NULL, 15, 'TP.Lạng Sơn', 1, 1);
INSERT INTO `fs_local_districts` VALUES (171, NULL, 15, 'H.Tràng Định', 8, 1);
INSERT INTO `fs_local_districts` VALUES (172, NULL, 15, 'H.Văn Lãng', 9, 1);
INSERT INTO `fs_local_districts` VALUES (173, NULL, 15, 'H.Văn Quan', 10, 1);
INSERT INTO `fs_local_districts` VALUES (174, NULL, 15, 'H.Bình Gia', 3, 1);
INSERT INTO `fs_local_districts` VALUES (175, NULL, 15, 'H.Bắc Sơn', 2, 1);
INSERT INTO `fs_local_districts` VALUES (176, NULL, 15, 'H.Hữu Lũng', 6, 1);
INSERT INTO `fs_local_districts` VALUES (177, NULL, 15, 'H.Chi Lăng', 5, 1);
INSERT INTO `fs_local_districts` VALUES (178, NULL, 15, 'H.Cao Lộc', 4, 1);
INSERT INTO `fs_local_districts` VALUES (179, NULL, 15, 'H.Lộc Bình', 7, 1);
INSERT INTO `fs_local_districts` VALUES (180, NULL, 15, 'H.Đình Lập', 11, 1);
INSERT INTO `fs_local_districts` VALUES (181, NULL, 16, 'H.Sa Pa', 7, 1);
INSERT INTO `fs_local_districts` VALUES (182, NULL, 16, 'TP.Lào Cai', 1, 1);
INSERT INTO `fs_local_districts` VALUES (183, NULL, 16, 'H.Bảo Thắng', 3, 1);
INSERT INTO `fs_local_districts` VALUES (184, NULL, 16, 'H.Bảo Yên', 4, 1);
INSERT INTO `fs_local_districts` VALUES (185, NULL, 16, 'H.Bát Xát', 5, 1);
INSERT INTO `fs_local_districts` VALUES (186, NULL, 16, 'H.Bắc Hà', 2, 1);
INSERT INTO `fs_local_districts` VALUES (187, NULL, 16, 'H.Mường Khương', 6, 1);
INSERT INTO `fs_local_districts` VALUES (188, NULL, 16, 'H.Si Ma Cai', 8, 1);
INSERT INTO `fs_local_districts` VALUES (189, NULL, 16, 'H.Văn Bàn', 9, 1);
INSERT INTO `fs_local_districts` VALUES (190, NULL, 17, 'H.Nghĩa Hưng', 6, 1);
INSERT INTO `fs_local_districts` VALUES (191, NULL, 17, 'H.Vụ Bản', 8, 1);
INSERT INTO `fs_local_districts` VALUES (192, NULL, 17, 'TP. Nam Định', 1, 1);
INSERT INTO `fs_local_districts` VALUES (193, NULL, 17, 'H.Hải Hậu', 3, 1);
INSERT INTO `fs_local_districts` VALUES (194, NULL, 17, 'H.Giao Thủy', 2, 1);
INSERT INTO `fs_local_districts` VALUES (195, NULL, 17, 'H.Ý Yên', 10, 1);
INSERT INTO `fs_local_districts` VALUES (196, NULL, 17, 'H.Trực Ninh', 7, 1);
INSERT INTO `fs_local_districts` VALUES (197, NULL, 17, 'H.Xuân Trường', 9, 1);
INSERT INTO `fs_local_districts` VALUES (198, NULL, 17, 'H.Nam Trực', 5, 1);
INSERT INTO `fs_local_districts` VALUES (199, NULL, 17, 'H.Mỹ Lộc', 4, 1);
INSERT INTO `fs_local_districts` VALUES (200, NULL, 18, ' H.Hoa Lư', 3, 1);
INSERT INTO `fs_local_districts` VALUES (201, NULL, 18, 'H.Kim Sơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (202, NULL, 18, 'H.Nho Quan', 6, 1);
INSERT INTO `fs_local_districts` VALUES (203, NULL, 18, 'TP.Ninh Bình', 1, 1);
INSERT INTO `fs_local_districts` VALUES (204, NULL, 18, 'TX.Tam Điệp', 2, 1);
INSERT INTO `fs_local_districts` VALUES (205, NULL, 18, 'H.Gia Viễn', 4, 1);
INSERT INTO `fs_local_districts` VALUES (206, NULL, 18, 'H.Yên Khánh', 7, 1);
INSERT INTO `fs_local_districts` VALUES (207, NULL, 18, 'H.Yên Mô', 8, 1);
INSERT INTO `fs_local_districts` VALUES (208, NULL, 19, 'H.Đoan Hùng ', 13, 1);
INSERT INTO `fs_local_districts` VALUES (209, NULL, 19, 'H.Thanh Sơn', 10, 1);
INSERT INTO `fs_local_districts` VALUES (210, NULL, 19, 'TP. Việt Trì', 1, 1);
INSERT INTO `fs_local_districts` VALUES (211, NULL, 19, 'TX Phú Thọ', 2, 1);
INSERT INTO `fs_local_districts` VALUES (212, NULL, 19, 'H.Cẩm Khê', 3, 1);
INSERT INTO `fs_local_districts` VALUES (213, NULL, 19, 'H.Hạ Hòa', 4, 1);
INSERT INTO `fs_local_districts` VALUES (214, NULL, 19, 'H.Lâm Thao', 5, 1);
INSERT INTO `fs_local_districts` VALUES (215, NULL, 19, 'H.Phù Ninh', 6, 1);
INSERT INTO `fs_local_districts` VALUES (216, NULL, 19, 'H.Tam Nông', 7, 1);
INSERT INTO `fs_local_districts` VALUES (217, NULL, 19, 'H.Tân Sơn', 8, 1);
INSERT INTO `fs_local_districts` VALUES (218, NULL, 19, 'H.Thạch Ba', 9, 1);
INSERT INTO `fs_local_districts` VALUES (219, NULL, 19, 'H.Thanh Thủy', 11, 1);
INSERT INTO `fs_local_districts` VALUES (220, NULL, 19, 'H.Yên Lập', 12, 1);
INSERT INTO `fs_local_districts` VALUES (221, NULL, 20, 'H.Đầm Hà', 13, 1);
INSERT INTO `fs_local_districts` VALUES (222, NULL, 20, 'H.Đông Triều', 14, 1);
INSERT INTO `fs_local_districts` VALUES (223, NULL, 20, 'H.Hoành Bồ', 10, 1);
INSERT INTO `fs_local_districts` VALUES (224, NULL, 20, 'H.Yên Hưng', 12, 1);
INSERT INTO `fs_local_districts` VALUES (225, NULL, 20, ' H.Vân Đồn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (226, NULL, 20, 'TP. Hạ Long', 1, 1);
INSERT INTO `fs_local_districts` VALUES (227, NULL, 20, 'TX.Cẩm Phả', 3, 1);
INSERT INTO `fs_local_districts` VALUES (228, NULL, 20, 'TP.Móng Cái', 2, 1);
INSERT INTO `fs_local_districts` VALUES (229, NULL, 20, 'TX.Uông Bí', 4, 1);
INSERT INTO `fs_local_districts` VALUES (230, NULL, 20, 'H.Ba Chế', 6, 1);
INSERT INTO `fs_local_districts` VALUES (231, NULL, 20, 'H.Bình Liêu', 7, 1);
INSERT INTO `fs_local_districts` VALUES (232, NULL, 20, 'H.Cô Tô', 8, 1);
INSERT INTO `fs_local_districts` VALUES (233, NULL, 20, 'H.Hải Hà', 9, 1);
INSERT INTO `fs_local_districts` VALUES (234, NULL, 20, 'H.Tiên Yên', 11, 1);
INSERT INTO `fs_local_districts` VALUES (235, NULL, 21, 'TP Sơn La', 1, 1);
INSERT INTO `fs_local_districts` VALUES (236, NULL, 21, 'H.Quỳnh Nhai', 7, 1);
INSERT INTO `fs_local_districts` VALUES (237, NULL, 21, 'H.Mường La', 5, 1);
INSERT INTO `fs_local_districts` VALUES (238, NULL, 21, 'H.Thuận Châu', 10, 1);
INSERT INTO `fs_local_districts` VALUES (239, NULL, 21, 'H.Phù Yên', 6, 1);
INSERT INTO `fs_local_districts` VALUES (240, NULL, 21, 'H.Bắc Yên', 2, 1);
INSERT INTO `fs_local_districts` VALUES (241, NULL, 21, 'H.Mai Sơn', 3, 1);
INSERT INTO `fs_local_districts` VALUES (242, NULL, 21, 'H.Sông Mã', 8, 1);
INSERT INTO `fs_local_districts` VALUES (243, NULL, 21, 'H.Yên Châu', 11, 1);
INSERT INTO `fs_local_districts` VALUES (244, NULL, 21, 'H.Mộc Châu', 4, 1);
INSERT INTO `fs_local_districts` VALUES (245, NULL, 21, 'H.Sốp Cộp', 9, 1);
INSERT INTO `fs_local_districts` VALUES (246, NULL, 22, 'H.Quỳnh Phụ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (247, NULL, 22, 'H.Vũ Thư', 7, 1);
INSERT INTO `fs_local_districts` VALUES (248, NULL, 22, 'TP.Thái Bình', 1, 1);
INSERT INTO `fs_local_districts` VALUES (249, NULL, 22, 'H.Đông Hưng', 8, 1);
INSERT INTO `fs_local_districts` VALUES (250, NULL, 22, 'H.Hưng Hà', 2, 1);
INSERT INTO `fs_local_districts` VALUES (251, NULL, 22, 'H.Kiến Xương', 3, 1);
INSERT INTO `fs_local_districts` VALUES (252, NULL, 22, 'H.Thái Thụy', 5, 1);
INSERT INTO `fs_local_districts` VALUES (253, NULL, 22, 'H.Tiền Hải', 6, 1);
INSERT INTO `fs_local_districts` VALUES (254, NULL, 23, 'TP.Thái Nguyên', 1, 1);
INSERT INTO `fs_local_districts` VALUES (255, NULL, 23, 'H.Phổ Yên', 3, 1);
INSERT INTO `fs_local_districts` VALUES (256, NULL, 23, 'TX.Sông Công', 2, 1);
INSERT INTO `fs_local_districts` VALUES (257, NULL, 23, 'H.Phú Bình', 4, 1);
INSERT INTO `fs_local_districts` VALUES (258, NULL, 23, 'H.Đồng Hỷ', 9, 1);
INSERT INTO `fs_local_districts` VALUES (259, NULL, 23, 'H.Võ Nhai', 6, 1);
INSERT INTO `fs_local_districts` VALUES (260, NULL, 23, 'H.Định Hóa', 8, 1);
INSERT INTO `fs_local_districts` VALUES (261, NULL, 23, 'H.Đại Từ', 7, 1);
INSERT INTO `fs_local_districts` VALUES (262, NULL, 23, 'H.Phú Lương', 5, 1);
INSERT INTO `fs_local_districts` VALUES (263, NULL, 24, ' H.Quảng Xương', 4, 1);
INSERT INTO `fs_local_districts` VALUES (264, NULL, 24, ' H.Triệu Sơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (265, NULL, 24, 'TP.Thanh Hoá', 1, 1);
INSERT INTO `fs_local_districts` VALUES (266, NULL, 24, 'TX.Bỉm Sơn', 2, 1);
INSERT INTO `fs_local_districts` VALUES (267, NULL, 24, 'TX.Sầm Sơn', 3, 1);
INSERT INTO `fs_local_districts` VALUES (268, NULL, 24, 'H.Như Xuân', 16, 1);
INSERT INTO `fs_local_districts` VALUES (269, NULL, 24, 'H.Tĩnh Gia', 24, 1);
INSERT INTO `fs_local_districts` VALUES (270, NULL, 24, 'H.Đông Sơn', 27, 1);
INSERT INTO `fs_local_districts` VALUES (271, NULL, 24, 'H.Hoằng Hóa', 10, 1);
INSERT INTO `fs_local_districts` VALUES (272, NULL, 24, 'H.Yên Định', 26, 1);
INSERT INTO `fs_local_districts` VALUES (273, NULL, 24, 'H.Vĩnh Lộc', 25, 1);
INSERT INTO `fs_local_districts` VALUES (274, NULL, 24, 'H.Thiệu Hóa', 21, 1);
INSERT INTO `fs_local_districts` VALUES (275, NULL, 24, 'H.Hậu Lộc', 9, 1);
INSERT INTO `fs_local_districts` VALUES (276, NULL, 24, 'H.Nga Sơn', 13, 1);
INSERT INTO `fs_local_districts` VALUES (277, NULL, 24, 'H.Hà Trung', 8, 1);
INSERT INTO `fs_local_districts` VALUES (278, NULL, 24, 'H.Nông Cống', 17, 1);
INSERT INTO `fs_local_districts` VALUES (279, NULL, 24, 'H.Thọ Xuân', 22, 1);
INSERT INTO `fs_local_districts` VALUES (280, NULL, 24, 'H.Ngọc Lặc', 14, 1);
INSERT INTO `fs_local_districts` VALUES (281, NULL, 24, 'H.Cẩm Thủy', 7, 1);
INSERT INTO `fs_local_districts` VALUES (282, NULL, 24, 'H.Thạch Thành', 20, 1);
INSERT INTO `fs_local_districts` VALUES (283, NULL, 24, 'H.Như Thành', 15, 1);
INSERT INTO `fs_local_districts` VALUES (284, NULL, 24, 'H.Thường Xuân', 23, 1);
INSERT INTO `fs_local_districts` VALUES (285, NULL, 24, 'H.Bá Thước', 6, 1);
INSERT INTO `fs_local_districts` VALUES (286, NULL, 24, 'H.Lang Chánh', 11, 1);
INSERT INTO `fs_local_districts` VALUES (287, NULL, 24, 'H.Quan Hóa', 18, 1);
INSERT INTO `fs_local_districts` VALUES (288, NULL, 24, 'H.Quan Sơn', 19, 1);
INSERT INTO `fs_local_districts` VALUES (289, NULL, 24, 'H.Mường Lát', 12, 1);
INSERT INTO `fs_local_districts` VALUES (290, NULL, 25, 'TX.Tuyên Quang', 1, 1);
INSERT INTO `fs_local_districts` VALUES (291, NULL, 25, 'H.Chiêm Hoá', 2, 1);
INSERT INTO `fs_local_districts` VALUES (292, NULL, 25, 'H.Yên Sơn', 6, 1);
INSERT INTO `fs_local_districts` VALUES (293, NULL, 25, 'H.Hàm Yên', 3, 1);
INSERT INTO `fs_local_districts` VALUES (294, NULL, 25, 'H.Na Hang', 4, 1);
INSERT INTO `fs_local_districts` VALUES (295, NULL, 25, 'H.Sơn Dương', 5, 1);
INSERT INTO `fs_local_districts` VALUES (296, NULL, 26, 'H.Bình Xuyên ', 3, 1);
INSERT INTO `fs_local_districts` VALUES (297, NULL, 26, 'H.Lập Thạch', 4, 1);
INSERT INTO `fs_local_districts` VALUES (298, NULL, 26, 'H.Tam Đảo', 7, 1);
INSERT INTO `fs_local_districts` VALUES (299, NULL, 26, 'H.Tam Dương', 6, 1);
INSERT INTO `fs_local_districts` VALUES (300, NULL, 26, 'TP.Vĩnh Yên ', 1, 1);
INSERT INTO `fs_local_districts` VALUES (301, NULL, 26, 'TX.Phúc Yên', 2, 1);
INSERT INTO `fs_local_districts` VALUES (302, NULL, 26, 'H.Sông Lô', 5, 1);
INSERT INTO `fs_local_districts` VALUES (303, NULL, 26, 'H.Vĩnh Tường', 8, 1);
INSERT INTO `fs_local_districts` VALUES (304, NULL, 26, 'H.Yên Lạc', 9, 1);
INSERT INTO `fs_local_districts` VALUES (305, NULL, 27, 'H.Yên Bình ', 9, 1);
INSERT INTO `fs_local_districts` VALUES (306, NULL, 27, 'TP.Yên Bái', 1, 1);
INSERT INTO `fs_local_districts` VALUES (307, NULL, 27, 'TX Nghĩa Lộ', 2, 1);
INSERT INTO `fs_local_districts` VALUES (308, NULL, 27, 'H.Lục Yên', 3, 1);
INSERT INTO `fs_local_districts` VALUES (309, NULL, 27, 'H.Mù Cang Chải', 4, 1);
INSERT INTO `fs_local_districts` VALUES (310, NULL, 27, 'H.Trấn Yên', 6, 1);
INSERT INTO `fs_local_districts` VALUES (311, NULL, 27, 'H.Trạm Tấu', 5, 1);
INSERT INTO `fs_local_districts` VALUES (312, NULL, 27, 'H.Văn Chấn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (313, NULL, 27, 'H.Văn Yên', 8, 1);
INSERT INTO `fs_local_districts` VALUES (314, NULL, 28, 'Q.Cẩm Lệ', 0, 1);
INSERT INTO `fs_local_districts` VALUES (315, NULL, 28, 'Q.Hải Châu', 0, 1);
INSERT INTO `fs_local_districts` VALUES (316, NULL, 28, 'Q.Liên Chiểu', 0, 1);
INSERT INTO `fs_local_districts` VALUES (317, NULL, 28, 'Q.Ngũ Hành Sơn', 0, 1);
INSERT INTO `fs_local_districts` VALUES (318, NULL, 28, 'Q.Sơn Trà', 0, 1);
INSERT INTO `fs_local_districts` VALUES (319, NULL, 28, 'Q.Thanh Khê', 0, 1);
INSERT INTO `fs_local_districts` VALUES (320, NULL, 28, 'H.Hoà Vang', 7, 1);
INSERT INTO `fs_local_districts` VALUES (321, NULL, 28, 'Huyện đảo Hoàng Sa', 8, 1);
INSERT INTO `fs_local_districts` VALUES (322, NULL, 29, 'H.Hoài Nhơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (323, NULL, 29, 'TP.Quy Nhơn', 1, 1);
INSERT INTO `fs_local_districts` VALUES (324, NULL, 29, 'H.An Lão', 2, 1);
INSERT INTO `fs_local_districts` VALUES (325, NULL, 29, 'H.An Nhơn', 3, 1);
INSERT INTO `fs_local_districts` VALUES (326, NULL, 29, 'H.Hoài Ân', 4, 1);
INSERT INTO `fs_local_districts` VALUES (327, NULL, 29, 'H.Phù Cát', 6, 1);
INSERT INTO `fs_local_districts` VALUES (328, NULL, 29, 'H.Phù Mỹ', 7, 1);
INSERT INTO `fs_local_districts` VALUES (329, NULL, 29, 'H.Tây Sơn', 8, 1);
INSERT INTO `fs_local_districts` VALUES (330, NULL, 29, 'H.Tuy Phước', 9, 1);
INSERT INTO `fs_local_districts` VALUES (331, NULL, 29, 'H.Vân Canh', 10, 1);
INSERT INTO `fs_local_districts` VALUES (332, NULL, 29, 'H.Vĩnh Thạnh', 11, 1);
INSERT INTO `fs_local_districts` VALUES (333, NULL, 30, 'TX.Bình Long', 3, 1);
INSERT INTO `fs_local_districts` VALUES (334, NULL, 30, 'H.Bù Đốp', 6, 1);
INSERT INTO `fs_local_districts` VALUES (335, NULL, 30, 'H.Chơn Thành', 7, 1);
INSERT INTO `fs_local_districts` VALUES (336, NULL, 30, 'H.Đồng Phú', 10, 1);
INSERT INTO `fs_local_districts` VALUES (337, NULL, 30, 'H.Lộc Ninh', 9, 1);
INSERT INTO `fs_local_districts` VALUES (338, NULL, 30, 'TX.Phước Long', 2, 1);
INSERT INTO `fs_local_districts` VALUES (339, NULL, 30, 'TX.Đồng Xoài', 1, 1);
INSERT INTO `fs_local_districts` VALUES (340, NULL, 30, 'H.Bù Gia Mập', 4, 1);
INSERT INTO `fs_local_districts` VALUES (341, NULL, 30, 'H.Bù Đăng', 5, 1);
INSERT INTO `fs_local_districts` VALUES (342, NULL, 30, 'H.Hớn Quản', 8, 1);
INSERT INTO `fs_local_districts` VALUES (343, NULL, 31, 'H.Bắc Bình', 3, 1);
INSERT INTO `fs_local_districts` VALUES (344, NULL, 31, 'H.Đức Linh', 10, 1);
INSERT INTO `fs_local_districts` VALUES (345, NULL, 31, 'H.Hàm Tân', 4, 1);
INSERT INTO `fs_local_districts` VALUES (346, NULL, 31, 'H.Hàm Thuận Bắc', 5, 1);
INSERT INTO `fs_local_districts` VALUES (347, NULL, 31, 'H.Hàm Thuận Nam', 6, 1);
INSERT INTO `fs_local_districts` VALUES (348, NULL, 31, 'H.Tánh Linh', 8, 1);
INSERT INTO `fs_local_districts` VALUES (349, NULL, 31, 'H.Tuy Phong', 9, 1);
INSERT INTO `fs_local_districts` VALUES (350, NULL, 31, 'TP. Phan Thiết', 1, 1);
INSERT INTO `fs_local_districts` VALUES (351, NULL, 31, 'TX.La Gi', 2, 1);
INSERT INTO `fs_local_districts` VALUES (352, NULL, 31, 'H.Phú Quý', 7, 1);
INSERT INTO `fs_local_districts` VALUES (353, NULL, 32, 'H.Buôn Đôn', 2, 1);
INSERT INTO `fs_local_districts` VALUES (354, NULL, 32, 'H.Cư M gar', 4, 1);
INSERT INTO `fs_local_districts` VALUES (355, NULL, 32, 'H.Ea Kar', 6, 1);
INSERT INTO `fs_local_districts` VALUES (356, NULL, 32, 'H.Krông Ana', 8, 1);
INSERT INTO `fs_local_districts` VALUES (357, NULL, 32, 'H.Krông Buk', 10, 1);
INSERT INTO `fs_local_districts` VALUES (358, NULL, 32, 'H.Krông Pắc', 12, 1);
INSERT INTO `fs_local_districts` VALUES (359, NULL, 32, 'TP.Buôn Ma Thuột', 1, 1);
INSERT INTO `fs_local_districts` VALUES (360, NULL, 32, 'H.Ea Suop', 7, 1);
INSERT INTO `fs_local_districts` VALUES (361, NULL, 32, 'H.Ea H\'Leo', 5, 1);
INSERT INTO `fs_local_districts` VALUES (362, NULL, 32, 'H.Krông Bông', 9, 1);
INSERT INTO `fs_local_districts` VALUES (363, NULL, 32, 'H.Krông Năng', 11, 1);
INSERT INTO `fs_local_districts` VALUES (364, NULL, 32, 'H.Cư Kuin', 3, 1);
INSERT INTO `fs_local_districts` VALUES (365, NULL, 32, 'H.M\'Đrăk', 13, 1);
INSERT INTO `fs_local_districts` VALUES (366, NULL, 33, 'H.Đăk R\'Lâp', 7, 1);
INSERT INTO `fs_local_districts` VALUES (367, NULL, 33, 'TX.Gia Nghĩa', 1, 1);
INSERT INTO `fs_local_districts` VALUES (368, NULL, 33, 'H.Đăk Song', 8, 1);
INSERT INTO `fs_local_districts` VALUES (369, NULL, 33, 'H.Đăk Mil', 6, 1);
INSERT INTO `fs_local_districts` VALUES (370, NULL, 33, 'H.Tuy Đức', 5, 1);
INSERT INTO `fs_local_districts` VALUES (371, NULL, 33, 'H.Cư Jut', 2, 1);
INSERT INTO `fs_local_districts` VALUES (372, NULL, 33, 'H.Krông Nô', 3, 1);
INSERT INTO `fs_local_districts` VALUES (373, NULL, 33, 'H.Lăk', 4, 1);
INSERT INTO `fs_local_districts` VALUES (374, NULL, 34, 'H.Chưprông', 7, 1);
INSERT INTO `fs_local_districts` VALUES (375, NULL, 34, 'H.Ia Grai', 8, 1);
INSERT INTO `fs_local_districts` VALUES (376, NULL, 34, 'TP.Pleiku', 1, 1);
INSERT INTO `fs_local_districts` VALUES (377, NULL, 34, 'TX An Khê', 2, 1);
INSERT INTO `fs_local_districts` VALUES (378, NULL, 34, 'TX Ayunpa', 3, 1);
INSERT INTO `fs_local_districts` VALUES (379, NULL, 34, 'H.Chư Păh', 4, 1);
INSERT INTO `fs_local_districts` VALUES (380, NULL, 34, 'H.Chư Pưh', 5, 1);
INSERT INTO `fs_local_districts` VALUES (381, NULL, 34, 'H.Chư Sê', 6, 1);
INSERT INTO `fs_local_districts` VALUES (382, NULL, 34, 'H.Đắk Đoa', 16, 1);
INSERT INTO `fs_local_districts` VALUES (383, NULL, 34, 'H.Đak Pơ', 15, 1);
INSERT INTO `fs_local_districts` VALUES (384, NULL, 34, 'H.Đức Cơ', 17, 1);
INSERT INTO `fs_local_districts` VALUES (385, NULL, 34, 'H.La Pa', 12, 1);
INSERT INTO `fs_local_districts` VALUES (386, NULL, 34, 'H.Kbang', 9, 1);
INSERT INTO `fs_local_districts` VALUES (387, NULL, 34, 'H.Kông Chro', 10, 1);
INSERT INTO `fs_local_districts` VALUES (388, NULL, 34, 'H.Krông Pa', 11, 1);
INSERT INTO `fs_local_districts` VALUES (389, NULL, 34, 'H.Mang Yang', 13, 1);
INSERT INTO `fs_local_districts` VALUES (390, NULL, 34, 'H.Phú Thiện', 14, 1);
INSERT INTO `fs_local_districts` VALUES (391, NULL, 35, 'H.Cẩm Xuyên', 3, 1);
INSERT INTO `fs_local_districts` VALUES (392, NULL, 35, 'TP.Hà Tĩnh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (393, NULL, 35, 'H.Can Lộc', 4, 1);
INSERT INTO `fs_local_districts` VALUES (394, NULL, 35, 'H.Đức Thọ', 12, 1);
INSERT INTO `fs_local_districts` VALUES (395, NULL, 35, 'TX Hồng Lĩnh', 2, 1);
INSERT INTO `fs_local_districts` VALUES (396, NULL, 35, 'H.Hương Khê', 5, 1);
INSERT INTO `fs_local_districts` VALUES (397, NULL, 35, 'H.Hương Sơn', 6, 1);
INSERT INTO `fs_local_districts` VALUES (398, NULL, 35, 'H.Kỳ Anh', 7, 1);
INSERT INTO `fs_local_districts` VALUES (399, NULL, 35, 'H.Nghi Xuân', 9, 1);
INSERT INTO `fs_local_districts` VALUES (400, NULL, 35, 'H.Thạch Hà', 10, 1);
INSERT INTO `fs_local_districts` VALUES (401, NULL, 35, 'H.Vũ Quang', 11, 1);
INSERT INTO `fs_local_districts` VALUES (402, NULL, 35, 'H.Lộc Hà', 8, 1);
INSERT INTO `fs_local_districts` VALUES (403, NULL, 36, 'H.Cam Lâm', 3, 1);
INSERT INTO `fs_local_districts` VALUES (404, NULL, 36, 'H.Khánh Vĩnh', 6, 1);
INSERT INTO `fs_local_districts` VALUES (405, NULL, 36, 'H.Ninh Hoà ', 7, 1);
INSERT INTO `fs_local_districts` VALUES (406, NULL, 36, 'H.Vạn Ninh', 8, 1);
INSERT INTO `fs_local_districts` VALUES (407, NULL, 36, 'TP.Nha Trang', 1, 1);
INSERT INTO `fs_local_districts` VALUES (408, NULL, 36, 'TX.Cam Ranh', 2, 1);
INSERT INTO `fs_local_districts` VALUES (409, NULL, 36, 'H.Diên Khánh', 4, 1);
INSERT INTO `fs_local_districts` VALUES (410, NULL, 36, 'H.Khánh Sơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (411, NULL, 36, 'Huyện đảo Trường Sa', 9, 1);
INSERT INTO `fs_local_districts` VALUES (412, NULL, 37, 'TP.KonTum', 1, 1);
INSERT INTO `fs_local_districts` VALUES (413, NULL, 37, 'H.Đắk Glei', 7, 1);
INSERT INTO `fs_local_districts` VALUES (414, NULL, 37, 'H.Đắk Hà', 8, 1);
INSERT INTO `fs_local_districts` VALUES (415, NULL, 37, 'H.Đắk Tô', 9, 1);
INSERT INTO `fs_local_districts` VALUES (416, NULL, 37, 'H.Kon Plông', 2, 1);
INSERT INTO `fs_local_districts` VALUES (417, NULL, 37, 'H.Kon Rẫy', 3, 1);
INSERT INTO `fs_local_districts` VALUES (418, NULL, 37, 'H.Ngọc Hồi', 4, 1);
INSERT INTO `fs_local_districts` VALUES (419, NULL, 37, 'H.Sa Thầy', 5, 1);
INSERT INTO `fs_local_districts` VALUES (420, NULL, 37, 'H.Tu Mơ Rông', 6, 1);
INSERT INTO `fs_local_districts` VALUES (421, NULL, 38, 'H.Bảo Lâm', 3, 1);
INSERT INTO `fs_local_districts` VALUES (422, NULL, 38, 'H.Đạ Huoai', 6, 1);
INSERT INTO `fs_local_districts` VALUES (423, NULL, 38, 'H.Di Linh', 0, 1);
INSERT INTO `fs_local_districts` VALUES (424, NULL, 38, 'H.Đức Trọng', 9, 1);
INSERT INTO `fs_local_districts` VALUES (425, NULL, 38, 'H.Lạc Dương', 0, 1);
INSERT INTO `fs_local_districts` VALUES (426, NULL, 38, 'H.Lâm Hà', 5, 1);
INSERT INTO `fs_local_districts` VALUES (427, NULL, 38, 'TP. Đà Lạt ', 1, 1);
INSERT INTO `fs_local_districts` VALUES (428, NULL, 38, 'TX.Bảo Lộc', 2, 1);
INSERT INTO `fs_local_districts` VALUES (429, NULL, 38, 'H.Đơn Dương', 8, 1);
INSERT INTO `fs_local_districts` VALUES (430, NULL, 38, 'H.Đạ Tẻh', 7, 1);
INSERT INTO `fs_local_districts` VALUES (431, NULL, 38, 'H.Cát Tiên', 4, 1);
INSERT INTO `fs_local_districts` VALUES (432, NULL, 39, 'H.Diễn Châu', 6, 1);
INSERT INTO `fs_local_districts` VALUES (433, NULL, 39, 'H.Đô Lương', 20, 1);
INSERT INTO `fs_local_districts` VALUES (434, NULL, 39, 'H.Hưng Nguyên', 7, 1);
INSERT INTO `fs_local_districts` VALUES (435, NULL, 39, 'H.Kỳ Sơn', 8, 1);
INSERT INTO `fs_local_districts` VALUES (436, NULL, 39, 'H.Nghi Lộc', 10, 1);
INSERT INTO `fs_local_districts` VALUES (437, NULL, 39, 'H.Quỳnh Lưu ', 15, 1);
INSERT INTO `fs_local_districts` VALUES (438, NULL, 39, 'H.Yên Thành', 19, 1);
INSERT INTO `fs_local_districts` VALUES (439, NULL, 39, 'TP.Vinh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (440, NULL, 39, 'TX.Cửa Lò', 3, 1);
INSERT INTO `fs_local_districts` VALUES (441, NULL, 39, 'TX Thái Hòa', 2, 1);
INSERT INTO `fs_local_districts` VALUES (442, NULL, 39, 'H.Anh Sơn', 4, 1);
INSERT INTO `fs_local_districts` VALUES (443, NULL, 39, 'H.Con Cuông', 5, 1);
INSERT INTO `fs_local_districts` VALUES (444, NULL, 39, 'H.Quỳ Châu', 13, 1);
INSERT INTO `fs_local_districts` VALUES (445, NULL, 39, 'H.Nam Đàn', 9, 1);
INSERT INTO `fs_local_districts` VALUES (446, NULL, 39, 'H.Nghĩa Đàn', 11, 1);
INSERT INTO `fs_local_districts` VALUES (447, NULL, 39, 'H.Quế Phong', 12, 1);
INSERT INTO `fs_local_districts` VALUES (448, NULL, 39, 'H.Quỳ Hợp', 14, 1);
INSERT INTO `fs_local_districts` VALUES (449, NULL, 39, 'H.Tân Kỳ', 16, 1);
INSERT INTO `fs_local_districts` VALUES (450, NULL, 39, 'H.Thanh Chương', 17, 1);
INSERT INTO `fs_local_districts` VALUES (451, NULL, 39, 'H.Tương Dương', 18, 1);
INSERT INTO `fs_local_districts` VALUES (452, NULL, 40, 'H.Ninh Phước', 4, 1);
INSERT INTO `fs_local_districts` VALUES (453, NULL, 40, 'TP.Phan Rang-Tháp Chàm', 1, 1);
INSERT INTO `fs_local_districts` VALUES (454, NULL, 40, 'H.Ninh Sơn', 5, 1);
INSERT INTO `fs_local_districts` VALUES (455, NULL, 40, 'H.Bác Ái', 2, 1);
INSERT INTO `fs_local_districts` VALUES (456, NULL, 40, 'H.Ninh Hải', 3, 1);
INSERT INTO `fs_local_districts` VALUES (457, NULL, 40, 'H.Thuận Bắc', 6, 1);
INSERT INTO `fs_local_districts` VALUES (458, NULL, 40, 'H.Thuận Nam', 7, 1);
INSERT INTO `fs_local_districts` VALUES (459, NULL, 41, 'H.Sơn Hoà', 4, 1);
INSERT INTO `fs_local_districts` VALUES (460, NULL, 41, 'TP.Tuy Hòa', 1, 1);
INSERT INTO `fs_local_districts` VALUES (461, NULL, 41, 'TX Sông Cầu', 2, 1);
INSERT INTO `fs_local_districts` VALUES (462, NULL, 41, 'H.Đông Hòa', 8, 1);
INSERT INTO `fs_local_districts` VALUES (463, NULL, 41, 'H.Đồng Xuân', 9, 1);
INSERT INTO `fs_local_districts` VALUES (464, NULL, 41, 'H.Phú Hòa', 3, 1);
INSERT INTO `fs_local_districts` VALUES (465, NULL, 41, 'H.Sông Hinh', 5, 1);
INSERT INTO `fs_local_districts` VALUES (466, NULL, 41, 'H.Tây Hòa', 6, 1);
INSERT INTO `fs_local_districts` VALUES (467, NULL, 41, 'H.Tuy An', 7, 1);
INSERT INTO `fs_local_districts` VALUES (468, NULL, 42, 'TP.Đồng Hới', 1, 1);
INSERT INTO `fs_local_districts` VALUES (469, NULL, 42, 'H.Quảng Trạch', 6, 1);
INSERT INTO `fs_local_districts` VALUES (470, NULL, 42, 'H.Lệ Thuỷ ', 3, 1);
INSERT INTO `fs_local_districts` VALUES (471, NULL, 42, 'H.Bố Trạch', 2, 1);
INSERT INTO `fs_local_districts` VALUES (472, NULL, 42, 'H.Minh Hóa', 4, 1);
INSERT INTO `fs_local_districts` VALUES (473, NULL, 42, 'H.Quảng Ninh', 5, 1);
INSERT INTO `fs_local_districts` VALUES (474, NULL, 42, 'H.Tuyên Hóa', 7, 1);
INSERT INTO `fs_local_districts` VALUES (475, NULL, 43, 'H.Bắc Trà My', 4, 1);
INSERT INTO `fs_local_districts` VALUES (476, NULL, 43, 'H.Đại Lộc', 16, 1);
INSERT INTO `fs_local_districts` VALUES (477, NULL, 43, 'H.Điện Bàn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (478, NULL, 43, 'H.Núi Thành', 10, 1);
INSERT INTO `fs_local_districts` VALUES (479, NULL, 43, 'H.Quế Sơn', 13, 1);
INSERT INTO `fs_local_districts` VALUES (480, NULL, 43, ' H.Thăng Bình', 3, 1);
INSERT INTO `fs_local_districts` VALUES (481, NULL, 43, 'TP.Tam Kỳ ', 1, 1);
INSERT INTO `fs_local_districts` VALUES (482, NULL, 43, 'TX.Hội An', 2, 1);
INSERT INTO `fs_local_districts` VALUES (483, NULL, 43, 'H.Nam Trà My', 8, 1);
INSERT INTO `fs_local_districts` VALUES (484, NULL, 43, 'H.Phước Sơn', 12, 1);
INSERT INTO `fs_local_districts` VALUES (485, NULL, 43, 'H.Tiên Phước', 15, 1);
INSERT INTO `fs_local_districts` VALUES (486, NULL, 43, 'H.Hiệp Đức', 6, 1);
INSERT INTO `fs_local_districts` VALUES (487, NULL, 43, 'H.Nông Sơn', 9, 1);
INSERT INTO `fs_local_districts` VALUES (488, NULL, 43, 'H.Đông Giang', 18, 1);
INSERT INTO `fs_local_districts` VALUES (489, NULL, 43, 'H.Nam Giang', 7, 1);
INSERT INTO `fs_local_districts` VALUES (490, NULL, 43, 'H.Phú Ninh', 11, 1);
INSERT INTO `fs_local_districts` VALUES (491, NULL, 43, 'H.Tây Giang', 14, 1);
INSERT INTO `fs_local_districts` VALUES (492, NULL, 43, 'H.Duy Xuyên', 5, 1);
INSERT INTO `fs_local_districts` VALUES (493, NULL, 44, 'H.Bình Sơn', 3, 1);
INSERT INTO `fs_local_districts` VALUES (494, NULL, 44, 'H.Đức Phổ', 14, 1);
INSERT INTO `fs_local_districts` VALUES (495, NULL, 44, 'H.Mộ Đức ', 6, 1);
INSERT INTO `fs_local_districts` VALUES (496, NULL, 44, 'H.Sơn Tịnh', 10, 1);
INSERT INTO `fs_local_districts` VALUES (497, NULL, 44, 'TP.Quảng Ngãi', 1, 1);
INSERT INTO `fs_local_districts` VALUES (498, NULL, 44, 'H.Ba Tơ', 2, 1);
INSERT INTO `fs_local_districts` VALUES (499, NULL, 44, 'H.Minh Long', 5, 1);
INSERT INTO `fs_local_districts` VALUES (500, NULL, 44, 'H.Nghĩa Hành', 7, 1);
INSERT INTO `fs_local_districts` VALUES (501, NULL, 44, 'H.Sơn Hà', 8, 1);
INSERT INTO `fs_local_districts` VALUES (502, NULL, 44, 'H.Sơn Tây', 9, 1);
INSERT INTO `fs_local_districts` VALUES (503, NULL, 44, 'H.Tây Trà', 11, 1);
INSERT INTO `fs_local_districts` VALUES (504, NULL, 44, 'H.Trà Bồng', 12, 1);
INSERT INTO `fs_local_districts` VALUES (505, NULL, 44, 'H.Tư Nghĩa', 13, 1);
INSERT INTO `fs_local_districts` VALUES (506, NULL, 44, 'H.Lý Sơn', 4, 1);
INSERT INTO `fs_local_districts` VALUES (507, NULL, 45, 'TP.Đông Hà', 1, 1);
INSERT INTO `fs_local_districts` VALUES (508, NULL, 45, 'TX Quảng Trị', 2, 1);
INSERT INTO `fs_local_districts` VALUES (509, NULL, 45, 'H.Cam Lộ', 3, 1);
INSERT INTO `fs_local_districts` VALUES (510, NULL, 45, 'H.Cồn Cỏ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (511, NULL, 45, 'H.Đa Krông', 10, 1);
INSERT INTO `fs_local_districts` VALUES (512, NULL, 45, 'H.Gio Linh', 5, 1);
INSERT INTO `fs_local_districts` VALUES (513, NULL, 45, 'H.Hải Lăng', 6, 1);
INSERT INTO `fs_local_districts` VALUES (514, NULL, 45, 'H.Hướng Hóa', 7, 1);
INSERT INTO `fs_local_districts` VALUES (515, NULL, 45, 'H.Triệu Phong', 8, 1);
INSERT INTO `fs_local_districts` VALUES (516, NULL, 45, 'H.Vĩnh Linh', 9, 1);
INSERT INTO `fs_local_districts` VALUES (517, NULL, 46, 'TP. Huế ', 1, 1);
INSERT INTO `fs_local_districts` VALUES (518, NULL, 46, 'TX Hương Thủy', 2, 1);
INSERT INTO `fs_local_districts` VALUES (519, NULL, 46, 'H. A Lưới', 3, 1);
INSERT INTO `fs_local_districts` VALUES (520, NULL, 46, 'H. Hương Trà', 4, 1);
INSERT INTO `fs_local_districts` VALUES (521, NULL, 46, 'H.Nam Đông', 5, 1);
INSERT INTO `fs_local_districts` VALUES (522, NULL, 46, 'H.Phong Điền', 6, 1);
INSERT INTO `fs_local_districts` VALUES (523, NULL, 46, 'H.Phú Lộc', 7, 1);
INSERT INTO `fs_local_districts` VALUES (524, NULL, 46, 'H.Phú Vang', 8, 1);
INSERT INTO `fs_local_districts` VALUES (525, NULL, 46, 'H.Quảng Điền', 9, 1);
INSERT INTO `fs_local_districts` VALUES (526, NULL, 47, 'H.Thới Lai', 8, 1);
INSERT INTO `fs_local_districts` VALUES (527, NULL, 47, 'H.Phong Điền', 7, 1);
INSERT INTO `fs_local_districts` VALUES (528, NULL, 47, 'Q.Bình Thuỷ', 0, 1);
INSERT INTO `fs_local_districts` VALUES (529, NULL, 47, 'Q.Cái Răng', 0, 1);
INSERT INTO `fs_local_districts` VALUES (530, NULL, 47, 'Q.Ninh Kiều', 0, 1);
INSERT INTO `fs_local_districts` VALUES (531, NULL, 47, 'Q.Ô Môn', 0, 1);
INSERT INTO `fs_local_districts` VALUES (532, NULL, 47, 'Q.Thốt Nốt', 0, 1);
INSERT INTO `fs_local_districts` VALUES (533, NULL, 47, 'H.Cờ Đỏ', 6, 1);
INSERT INTO `fs_local_districts` VALUES (534, NULL, 47, 'H.Vĩnh Thạch', 9, 1);
INSERT INTO `fs_local_districts` VALUES (535, NULL, 48, 'H.Thoại Sơn', 9, 1);
INSERT INTO `fs_local_districts` VALUES (536, NULL, 48, 'TP.Long Xuyên', 1, 1);
INSERT INTO `fs_local_districts` VALUES (537, NULL, 48, 'TX Châu Đốc', 2, 1);
INSERT INTO `fs_local_districts` VALUES (538, NULL, 48, 'H.An Phú', 4, 1);
INSERT INTO `fs_local_districts` VALUES (539, NULL, 48, 'H.Châu Phú', 5, 1);
INSERT INTO `fs_local_districts` VALUES (540, NULL, 48, 'H.Châu Thành', 6, 1);
INSERT INTO `fs_local_districts` VALUES (541, NULL, 48, 'H.Chợ Mới', 7, 1);
INSERT INTO `fs_local_districts` VALUES (542, NULL, 48, 'H.Phú Tân', 8, 1);
INSERT INTO `fs_local_districts` VALUES (543, NULL, 48, 'H.Tịnh Biên', 10, 1);
INSERT INTO `fs_local_districts` VALUES (544, NULL, 48, 'H.Tri Tôn', 11, 1);
INSERT INTO `fs_local_districts` VALUES (545, NULL, 48, 'TX Tân Châu', 3, 1);
INSERT INTO `fs_local_districts` VALUES (546, NULL, 49, 'H.Châu Đức', 3, 1);
INSERT INTO `fs_local_districts` VALUES (547, NULL, 49, 'H.Côn Đảo', 4, 1);
INSERT INTO `fs_local_districts` VALUES (548, NULL, 49, 'H.Đất Đỏ', 8, 1);
INSERT INTO `fs_local_districts` VALUES (549, NULL, 49, 'H.Long Điền', 5, 1);
INSERT INTO `fs_local_districts` VALUES (550, NULL, 49, 'H.Tân Thành', 6, 1);
INSERT INTO `fs_local_districts` VALUES (551, NULL, 49, 'H.Xuyên Mộc', 7, 1);
INSERT INTO `fs_local_districts` VALUES (552, NULL, 49, 'TP.Vũng Tàu', 1, 1);
INSERT INTO `fs_local_districts` VALUES (553, NULL, 49, 'TX.Bà Rịa', 2, 1);
INSERT INTO `fs_local_districts` VALUES (554, NULL, 50, 'TX Bạc Liêu', 1, 1);
INSERT INTO `fs_local_districts` VALUES (555, NULL, 50, 'H.Phước Long', 5, 1);
INSERT INTO `fs_local_districts` VALUES (556, NULL, 50, 'H.Hồng Dân', 4, 1);
INSERT INTO `fs_local_districts` VALUES (557, NULL, 50, 'H.Vĩnh Lợi', 6, 1);
INSERT INTO `fs_local_districts` VALUES (558, NULL, 50, 'H.Giá Rai', 2, 1);
INSERT INTO `fs_local_districts` VALUES (559, NULL, 50, 'H.Đông Hải', 7, 1);
INSERT INTO `fs_local_districts` VALUES (560, NULL, 50, 'H.Hòa Bình', 3, 1);
INSERT INTO `fs_local_districts` VALUES (561, NULL, 51, 'H.Ba Tri', 2, 1);
INSERT INTO `fs_local_districts` VALUES (562, NULL, 51, 'H.Bình Đại', 3, 1);
INSERT INTO `fs_local_districts` VALUES (563, NULL, 51, 'H.Châu Thành', 4, 1);
INSERT INTO `fs_local_districts` VALUES (564, NULL, 51, 'H.Chợ Lách', 5, 1);
INSERT INTO `fs_local_districts` VALUES (565, NULL, 51, 'H.Giồng Trôm', 6, 1);
INSERT INTO `fs_local_districts` VALUES (566, NULL, 51, 'H.Mỏ Cày', 7, 1);
INSERT INTO `fs_local_districts` VALUES (567, NULL, 51, 'TX.Bến Tre', 1, 1);
INSERT INTO `fs_local_districts` VALUES (568, NULL, 51, 'H.Thạnh Phú', 8, 1);
INSERT INTO `fs_local_districts` VALUES (569, NULL, 52, 'H.Bến Cát', 2, 1);
INSERT INTO `fs_local_districts` VALUES (570, NULL, 52, 'H.Dầu Tiếng', 3, 1);
INSERT INTO `fs_local_districts` VALUES (571, NULL, 52, 'H.Dĩ An', 4, 1);
INSERT INTO `fs_local_districts` VALUES (572, NULL, 52, 'H.Phú Giáo', 5, 1);
INSERT INTO `fs_local_districts` VALUES (573, NULL, 52, 'H.Tân Uyên', 6, 1);
INSERT INTO `fs_local_districts` VALUES (574, NULL, 52, 'H.Thuận An', 7, 1);
INSERT INTO `fs_local_districts` VALUES (575, NULL, 52, 'TX.Thủ Dầu Một', 1, 1);
INSERT INTO `fs_local_districts` VALUES (576, NULL, 53, 'H.Năm Căn', 3, 1);
INSERT INTO `fs_local_districts` VALUES (577, NULL, 53, 'TP. Cà Mau', 1, 1);
INSERT INTO `fs_local_districts` VALUES (578, NULL, 53, 'H.Cái Nước', 2, 1);
INSERT INTO `fs_local_districts` VALUES (579, NULL, 53, 'H.Ngọc Hiển', 4, 1);
INSERT INTO `fs_local_districts` VALUES (580, NULL, 53, 'H.Thới Bình', 5, 1);
INSERT INTO `fs_local_districts` VALUES (581, NULL, 53, 'H.Trần Văn Thời', 6, 1);
INSERT INTO `fs_local_districts` VALUES (582, NULL, 53, 'H.U Minh', 7, 1);
INSERT INTO `fs_local_districts` VALUES (583, NULL, 53, 'H.Đầm Dơi', 8, 1);
INSERT INTO `fs_local_districts` VALUES (584, NULL, 54, 'H.Cẩm Mỹ', 3, 1);
INSERT INTO `fs_local_districts` VALUES (585, NULL, 54, 'H.Định Quán', 11, 1);
INSERT INTO `fs_local_districts` VALUES (586, NULL, 54, 'H.Long Thành', 4, 1);
INSERT INTO `fs_local_districts` VALUES (587, NULL, 54, 'H.Nhơn Trạch', 5, 1);
INSERT INTO `fs_local_districts` VALUES (588, NULL, 54, 'H.Thống Nhất', 7, 1);
INSERT INTO `fs_local_districts` VALUES (589, NULL, 54, 'H.Trảng Bom', 8, 1);
INSERT INTO `fs_local_districts` VALUES (590, NULL, 54, 'H.Vĩnh Cửu', 9, 1);
INSERT INTO `fs_local_districts` VALUES (591, NULL, 54, 'H.Xuân Lộc', 10, 1);
INSERT INTO `fs_local_districts` VALUES (592, NULL, 54, 'TP.Biên Hoà', 1, 1);
INSERT INTO `fs_local_districts` VALUES (593, NULL, 54, 'TX.Long Khánh', 2, 1);
INSERT INTO `fs_local_districts` VALUES (594, NULL, 54, 'H.Tân Phú', 6, 1);
INSERT INTO `fs_local_districts` VALUES (595, NULL, 55, 'H.Châu Thành', 3, 1);
INSERT INTO `fs_local_districts` VALUES (596, NULL, 55, 'H.Lai Vung', 5, 1);
INSERT INTO `fs_local_districts` VALUES (597, NULL, 55, 'H.Tháp Mười', 10, 1);
INSERT INTO `fs_local_districts` VALUES (598, NULL, 55, 'TP.Cao Lãnh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (599, NULL, 55, 'TX.Sa Đéc', 2, 1);
INSERT INTO `fs_local_districts` VALUES (600, NULL, 55, 'H.Hồng Ngự', 4, 1);
INSERT INTO `fs_local_districts` VALUES (601, NULL, 55, 'H.Lấp Vò', 6, 1);
INSERT INTO `fs_local_districts` VALUES (602, NULL, 55, 'H.Tam Nông', 7, 1);
INSERT INTO `fs_local_districts` VALUES (603, NULL, 55, 'H.Tân Hồng', 8, 1);
INSERT INTO `fs_local_districts` VALUES (604, NULL, 55, 'H.Thanh Bình', 9, 1);
INSERT INTO `fs_local_districts` VALUES (605, NULL, 56, 'TX.Vị Thanh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (606, NULL, 56, 'TX. Ngã Bảy', 2, 1);
INSERT INTO `fs_local_districts` VALUES (607, NULL, 56, 'H.Châu Thành', 3, 1);
INSERT INTO `fs_local_districts` VALUES (608, NULL, 56, 'H.Châu Thành A', 4, 1);
INSERT INTO `fs_local_districts` VALUES (609, NULL, 56, 'H.Long Mỹ', 5, 1);
INSERT INTO `fs_local_districts` VALUES (610, NULL, 56, 'H.Phụng Hiệp', 6, 1);
INSERT INTO `fs_local_districts` VALUES (611, NULL, 56, 'H.Vị Thủy', 7, 1);
INSERT INTO `fs_local_districts` VALUES (612, NULL, 57, 'H.Phú Quốc', 12, 1);
INSERT INTO `fs_local_districts` VALUES (613, NULL, 57, 'TP.Rạch Giá', 1, 1);
INSERT INTO `fs_local_districts` VALUES (614, NULL, 57, 'TX. Hà Tiên', 2, 1);
INSERT INTO `fs_local_districts` VALUES (615, NULL, 57, 'H.An Biên', 3, 1);
INSERT INTO `fs_local_districts` VALUES (616, NULL, 57, 'H.An Minh', 4, 1);
INSERT INTO `fs_local_districts` VALUES (617, NULL, 57, 'H.Châu Thành', 5, 1);
INSERT INTO `fs_local_districts` VALUES (618, NULL, 57, 'H.Giồng Riềng', 7, 1);
INSERT INTO `fs_local_districts` VALUES (619, NULL, 57, 'H.Gò Quao', 8, 1);
INSERT INTO `fs_local_districts` VALUES (620, NULL, 57, 'H.Hòn Đất', 9, 1);
INSERT INTO `fs_local_districts` VALUES (621, NULL, 57, 'H.Kiên Hải', 10, 1);
INSERT INTO `fs_local_districts` VALUES (622, NULL, 57, 'H.Kiên Lương', 11, 1);
INSERT INTO `fs_local_districts` VALUES (623, NULL, 57, 'H.Tân Hiệp', 13, 1);
INSERT INTO `fs_local_districts` VALUES (624, NULL, 57, 'H.Vĩnh Thuận', 15, 1);
INSERT INTO `fs_local_districts` VALUES (625, NULL, 57, 'H.U Minh Thượng', 14, 1);
INSERT INTO `fs_local_districts` VALUES (626, NULL, 57, 'H.Giang Thành', 6, 1);
INSERT INTO `fs_local_districts` VALUES (627, NULL, 58, 'H.Bến Lức ', 2, 1);
INSERT INTO `fs_local_districts` VALUES (628, NULL, 58, 'H.Cần Đước', 4, 1);
INSERT INTO `fs_local_districts` VALUES (629, NULL, 58, 'H.Cần Giuộc', 3, 1);
INSERT INTO `fs_local_districts` VALUES (630, NULL, 58, 'H.Đức Hoà', 13, 1);
INSERT INTO `fs_local_districts` VALUES (631, NULL, 58, 'H.Đức Huệ', 14, 1);
INSERT INTO `fs_local_districts` VALUES (632, NULL, 58, 'H.Mộc Hoá ', 6, 1);
INSERT INTO `fs_local_districts` VALUES (633, NULL, 58, 'H.Tân Trụ', 9, 1);
INSERT INTO `fs_local_districts` VALUES (634, NULL, 58, 'H.Thủ Thừa', 11, 1);
INSERT INTO `fs_local_districts` VALUES (635, NULL, 58, 'TX.Tân An', 1, 1);
INSERT INTO `fs_local_districts` VALUES (636, NULL, 58, 'H.Thạch Hóa', 10, 1);
INSERT INTO `fs_local_districts` VALUES (637, NULL, 58, 'H.Châu Thành', 5, 1);
INSERT INTO `fs_local_districts` VALUES (638, NULL, 58, 'H.Tân Hưng', 7, 1);
INSERT INTO `fs_local_districts` VALUES (639, NULL, 58, 'H.Tân Thạch', 8, 1);
INSERT INTO `fs_local_districts` VALUES (640, NULL, 58, 'H.Vĩnh Hưng', 12, 1);
INSERT INTO `fs_local_districts` VALUES (641, NULL, 59, 'H.Mỹ Xuyên', 7, 1);
INSERT INTO `fs_local_districts` VALUES (642, NULL, 59, 'TP.Sóc Trăng', 1, 1);
INSERT INTO `fs_local_districts` VALUES (643, NULL, 59, 'H.Cù Lao Dung', 3, 1);
INSERT INTO `fs_local_districts` VALUES (644, NULL, 59, 'H.Kế Sách', 4, 1);
INSERT INTO `fs_local_districts` VALUES (645, NULL, 59, 'H.Long Phú', 5, 1);
INSERT INTO `fs_local_districts` VALUES (646, NULL, 59, 'H.Mỹ Tú', 6, 1);
INSERT INTO `fs_local_districts` VALUES (647, NULL, 59, 'H.Ngã Năm', 8, 1);
INSERT INTO `fs_local_districts` VALUES (648, NULL, 59, 'H.Thạch Trị', 9, 1);
INSERT INTO `fs_local_districts` VALUES (649, NULL, 59, 'H.Vĩnh Châu', 11, 1);
INSERT INTO `fs_local_districts` VALUES (650, NULL, 59, 'H.Châu Thành', 2, 1);
INSERT INTO `fs_local_districts` VALUES (651, NULL, 59, 'H.Trần Đề', 10, 1);
INSERT INTO `fs_local_districts` VALUES (652, NULL, 60, 'H.Bến Cầu', 2, 1);
INSERT INTO `fs_local_districts` VALUES (653, NULL, 60, 'H.Châu Thành', 3, 1);
INSERT INTO `fs_local_districts` VALUES (654, NULL, 60, 'H.Dương Minh Châu', 4, 1);
INSERT INTO `fs_local_districts` VALUES (655, NULL, 60, 'H.Gò Dầu', 5, 1);
INSERT INTO `fs_local_districts` VALUES (656, NULL, 60, 'H.Hoà Thành', 6, 1);
INSERT INTO `fs_local_districts` VALUES (657, NULL, 60, 'H.Tân Biên', 7, 1);
INSERT INTO `fs_local_districts` VALUES (658, NULL, 60, 'H.Tân Châu', 8, 1);
INSERT INTO `fs_local_districts` VALUES (659, NULL, 60, 'H.Trảng Bàng', 9, 1);
INSERT INTO `fs_local_districts` VALUES (660, NULL, 60, 'TX.Tây Ninh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (661, NULL, 61, 'H.Chợ Gạo', 6, 1);
INSERT INTO `fs_local_districts` VALUES (662, NULL, 61, 'H.Gò Công Đông', 8, 1);
INSERT INTO `fs_local_districts` VALUES (663, NULL, 61, 'H.Gò Công Tây', 7, 1);
INSERT INTO `fs_local_districts` VALUES (664, NULL, 61, 'H.Tân Phước', 10, 1);
INSERT INTO `fs_local_districts` VALUES (665, NULL, 61, 'TP.Mỹ Tho', 1, 1);
INSERT INTO `fs_local_districts` VALUES (666, NULL, 61, 'TX.Gò Công', 2, 1);
INSERT INTO `fs_local_districts` VALUES (667, NULL, 61, ' H.Cái Bè', 3, 1);
INSERT INTO `fs_local_districts` VALUES (668, NULL, 61, 'H.Cai Lậy', 5, 1);
INSERT INTO `fs_local_districts` VALUES (669, NULL, 61, ' H.Châu Thành', 4, 1);
INSERT INTO `fs_local_districts` VALUES (670, NULL, 61, 'H.Tân Phú Đông', 9, 1);
INSERT INTO `fs_local_districts` VALUES (671, NULL, 62, 'TP.Trà Vinh', 1, 1);
INSERT INTO `fs_local_districts` VALUES (672, NULL, 62, 'H.Càng Long', 2, 1);
INSERT INTO `fs_local_districts` VALUES (673, NULL, 62, 'H.Châu Thành', 5, 1);
INSERT INTO `fs_local_districts` VALUES (674, NULL, 62, 'H.Cầu Kè', 3, 1);
INSERT INTO `fs_local_districts` VALUES (675, NULL, 62, 'H.Tiểu Cần', 7, 1);
INSERT INTO `fs_local_districts` VALUES (676, NULL, 62, 'H.Cầu Ngang', 4, 1);
INSERT INTO `fs_local_districts` VALUES (677, NULL, 62, 'H.Trà Cú', 8, 1);
INSERT INTO `fs_local_districts` VALUES (678, NULL, 62, 'H.Duyên Hải', 6, 1);
INSERT INTO `fs_local_districts` VALUES (679, NULL, 63, 'H.Bình Minh', 2, 1);
INSERT INTO `fs_local_districts` VALUES (680, NULL, 63, 'H.Long Hồ', 4, 1);
INSERT INTO `fs_local_districts` VALUES (681, NULL, 63, 'H.Mang Thít', 5, 1);
INSERT INTO `fs_local_districts` VALUES (682, NULL, 63, 'H.Tam Bình', 6, 1);
INSERT INTO `fs_local_districts` VALUES (683, NULL, 63, 'H.Trà Ôn', 7, 1);
INSERT INTO `fs_local_districts` VALUES (684, NULL, 63, 'TX.Vĩnh Long', 1, 1);
INSERT INTO `fs_local_districts` VALUES (685, NULL, 63, 'H.Bình Tân', 3, 1);
INSERT INTO `fs_local_districts` VALUES (686, NULL, 63, 'H.Vũng Liêm', 8, 1);
INSERT INTO `fs_local_districts` VALUES (687, NULL, 63, 'Quận 5', 30, 1);
INSERT INTO `fs_local_districts` VALUES (688, NULL, 63, 'Quận 4', 31, 1);
INSERT INTO `fs_local_districts` VALUES (689, NULL, 63, 'Quận 3', 32, 1);
INSERT INTO `fs_local_districts` VALUES (690, NULL, 1, 'Quận Ba Đình', 33, 1);
INSERT INTO `fs_local_districts` VALUES (691, NULL, 1, 'Quận Hoàn Kiếm', 34, 1);
INSERT INTO `fs_local_districts` VALUES (692, NULL, 1, 'Quận Đống Đa', 35, 1);
INSERT INTO `fs_local_districts` VALUES (693, NULL, 1, 'Quận Cầu Giấy', 36, 1);
INSERT INTO `fs_local_districts` VALUES (694, NULL, 63, 'Quận 1', 37, 1);
INSERT INTO `fs_local_districts` VALUES (695, NULL, 63, 'Quận 2', 38, 1);

-- ----------------------------
-- Table structure for fs_local_streets
-- ----------------------------
DROP TABLE IF EXISTS `fs_local_streets`;
...
-- ----------------------------
-- Records of fs_local_streets
-- ----------------------------
INSERT INTO `fs_local_streets` VALUES (1, NULL, 1, 2, 'Giảng Võ', 1, 1, '2015-12-16 09:25:17', '2015-12-16 10:31:04');
INSERT INTO `fs_local_streets` VALUES (2, NULL, 1, 2, 'Liễu Giai', 2, 1, '2015-12-16 10:31:22', '2015-12-16 10:31:22');
INSERT INTO `fs_local_streets` VALUES (3, NULL, 1, 2, 'La Thành', 3, 1, '2015-12-16 10:31:49', '2015-12-16 10:31:49');
INSERT INTO `fs_local_streets` VALUES (4, NULL, 1, 1, 'Bà Triệu', 4, 1, '2015-12-16 10:32:37', '2015-12-16 10:32:37');
INSERT INTO `fs_local_streets` VALUES (5, NULL, 1, 1, 'Bát Đàn', 5, 1, '2015-12-16 10:32:57', '2015-12-16 10:32:57');
INSERT INTO `fs_local_streets` VALUES (6, NULL, 1, 1, 'Đồng Xuân', 6, 1, '2015-12-16 10:33:13', '2015-12-16 10:33:13');
INSERT INTO `fs_local_streets` VALUES (7, NULL, 1, 7, 'Bưởi', 7, 1, '2015-12-16 10:33:44', '2015-12-16 10:33:44');
INSERT INTO `fs_local_streets` VALUES (8, NULL, 1, 7, 'Mai Dịch', 8, 1, '2015-12-16 10:33:57', '2015-12-16 10:33:57');
INSERT INTO `fs_local_streets` VALUES (9, NULL, 1, 7, 'Doãn Kế Thiện', 9, 1, '2015-12-16 10:34:15', '2015-12-16 10:34:15');
INSERT INTO `fs_local_streets` VALUES (10, NULL, 1, 7, 'Hoàng Quốc Việt', 10, 1, '2015-12-16 10:34:36', '2015-12-16 10:34:36');
INSERT INTO `fs_local_streets` VALUES (11, NULL, 1, 3, 'Thái Thịnh', 11, 1, '2015-12-16 10:35:16', '2015-12-16 10:37:06');
INSERT INTO `fs_local_streets` VALUES (12, NULL, 1, 3, 'Cát Linh', 12, 1, '2015-12-16 10:35:58', '2015-12-16 10:36:25');
INSERT INTO `fs_local_streets` VALUES (13, NULL, 1, 3, 'Thái Hà', 13, 1, '2015-12-16 10:37:31', '2015-12-16 10:37:31');
INSERT INTO `fs_local_streets` VALUES (14, NULL, 2, 34, 'An Bình', 14, 1, '2015-12-16 10:42:45', '2015-12-16 10:42:45');
INSERT INTO `fs_local_streets` VALUES (15, NULL, 2, 34, 'An Biên', 15, 1, '2015-12-16 10:43:04', '2015-12-16 10:43:04');
INSERT INTO `fs_local_streets` VALUES (16, NULL, 2, 34, 'An Dương Vương', 16, 1, '2015-12-16 10:43:18', '2015-12-16 10:43:19');
INSERT INTO `fs_local_streets` VALUES (17, NULL, 2, 33, 'Bến Vân Đồn', 17, 1, '2015-12-16 10:43:45', '2015-12-16 10:43:45');
INSERT INTO `fs_local_streets` VALUES (18, NULL, 2, 33, 'Đinh Lễ', 18, 1, '2015-12-16 10:44:53', '2015-12-16 10:44:53');
INSERT INTO `fs_local_streets` VALUES (19, NULL, 2, 33, 'Đoàn Văn Bơ', 19, 1, '2015-12-16 10:45:05', '2015-12-16 10:45:05');
INSERT INTO `fs_local_streets` VALUES (20, NULL, 2, 32, 'Bàn Cờ', 20, 1, '2015-12-16 10:45:47', '2015-12-16 10:45:47');
INSERT INTO `fs_local_streets` VALUES (21, NULL, 2, 32, 'Cách Mạng Tháng Tám', 21, 1, '2015-12-16 10:46:00', '2015-12-16 10:46:00');
INSERT INTO `fs_local_streets` VALUES (22, NULL, 2, 32, 'Cao Thắng', 22, 1, '2015-12-16 10:46:11', '2015-12-16 10:46:11');
INSERT INTO `fs_local_streets` VALUES (23, NULL, 2, 32, 'Điện Biên Phủ', 23, 1, '2015-12-16 10:46:23', '2015-12-16 10:46:23');

-- ----------------------------
-- Table structure for fs_local_ward
-- ----------------------------
DROP TABLE IF EXISTS `fs_local_ward`;
...
-- ----------------------------
-- Records of fs_local_ward
-- ----------------------------
INSERT INTO `fs_local_ward` VALUES (1, NULL, 30, 'Phường Tân Định', 1, 1, '2015-12-16 09:53:42', '2015-12-16 09:53:42');
INSERT INTO `fs_local_ward` VALUES (2, NULL, 30, 'Phường Đa Kao', 2, 1, '2015-12-16 09:54:03', '2015-12-16 09:54:03');
INSERT INTO `fs_local_ward` VALUES (3, NULL, 30, 'Phường Bến Nghé', 3, 1, '2015-12-16 09:54:29', '2015-12-16 09:54:29');
INSERT INTO `fs_local_ward` VALUES (4, NULL, 30, 'Phường Bến Thành', 4, 1, '2015-12-16 09:54:45', '2015-12-16 09:54:45');
INSERT INTO `fs_local_ward` VALUES (5, NULL, 30, 'Phường Nguyễn Thái Bình', 5, 1, '2015-12-16 09:55:00', '2015-12-16 09:55:01');
INSERT INTO `fs_local_ward` VALUES (6, NULL, 31, 'Phường Thảo Điền', 6, 1, '2015-12-16 09:59:55', '2015-12-16 09:59:55');
INSERT INTO `fs_local_ward` VALUES (7, NULL, 31, 'Phường An Phú', 7, 1, '2015-12-16 10:00:11', '2015-12-16 10:00:11');
INSERT INTO `fs_local_ward` VALUES (8, NULL, 34, 'Phường 3', 8, 1, '2015-12-16 10:00:27', '2015-12-16 10:53:01');
INSERT INTO `fs_local_ward` VALUES (9, NULL, 34, 'Phường 2', 9, 1, '2015-12-16 10:00:44', '2015-12-16 10:52:50');
INSERT INTO `fs_local_ward` VALUES (10, NULL, 34, 'Phường 1', 10, 1, '2015-12-16 10:01:00', '2015-12-16 10:52:34');
INSERT INTO `fs_local_ward` VALUES (11, NULL, 32, 'Phường 07', 11, 1, '2015-12-16 10:01:31', '2015-12-16 10:01:31');
INSERT INTO `fs_local_ward` VALUES (12, NULL, 32, 'Phường 14', 12, 1, '2015-12-16 10:02:27', '2015-12-16 10:02:39');
INSERT INTO `fs_local_ward` VALUES (13, NULL, 32, 'Phường 08', 13, 1, '2015-12-16 10:02:56', '2015-12-16 10:02:59');
INSERT INTO `fs_local_ward` VALUES (14, NULL, 32, 'Phường 10', 14, 1, '2015-12-16 10:03:16', '2015-12-16 10:03:26');
INSERT INTO `fs_local_ward` VALUES (15, NULL, 33, 'Phường 12', 15, 1, '2015-12-16 10:03:53', '2015-12-16 10:03:53');
INSERT INTO `fs_local_ward` VALUES (16, NULL, 33, 'Phường 13', 16, 1, '2015-12-16 10:04:09', '2015-12-16 10:04:09');
INSERT INTO `fs_local_ward` VALUES (17, NULL, 32, 'Phường 09', 17, 1, '2015-12-16 10:04:22', '2015-12-16 10:04:22');
INSERT INTO `fs_local_ward` VALUES (18, NULL, 33, 'Phường 06', 18, 1, '2015-12-16 10:04:40', '2015-12-16 10:04:40');
INSERT INTO `fs_local_ward` VALUES (19, NULL, 3, 'Cát Linh', 19, 1, '2015-12-16 10:38:29', '2015-12-16 10:38:29');
INSERT INTO `fs_local_ward` VALUES (20, NULL, 3, 'Khâm Thiên', 20, 1, '2015-12-16 10:38:53', '2015-12-16 10:38:53');
INSERT INTO `fs_local_ward` VALUES (21, NULL, 3, 'Trung Liệt', 21, 1, '2015-12-16 10:39:17', '2015-12-16 10:39:17');
INSERT INTO `fs_local_ward` VALUES (22, NULL, 7, 'Dịch vọng', 22, 1, '2015-12-16 10:39:50', '2015-12-16 10:39:50');
INSERT INTO `fs_local_ward` VALUES (23, NULL, 7, 'Nghĩa Đô', 23, 1, '2015-12-16 10:40:09', '2015-12-16 10:40:09');
INSERT INTO `fs_local_ward` VALUES (24, NULL, 7, 'Trung Hòa', 24, 1, '2015-12-16 10:40:30', '2015-12-16 10:40:30');
INSERT INTO `fs_local_ward` VALUES (25, NULL, 2, 'Điện Biên', 25, 1, '2015-12-16 10:41:07', '2015-12-16 10:41:07');
INSERT INTO `fs_local_ward` VALUES (26, NULL, 2, 'Đội Cấn', 26, 1, '2015-12-16 10:41:22', '2015-12-16 10:41:22');
INSERT INTO `fs_local_ward` VALUES (27, NULL, 2, 'Trúc Bạch', 27, 1, '2015-12-16 10:41:40', '2015-12-16 10:41:40');
...
CREATE TABLE `fs_members`  (
  ...
  `poster_avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `poster_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `poster_mobile` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `poster_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `poster_address` varchar(4000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `poster_facebook` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `company_mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `company_website` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `company_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `company_longitude` double NULL DEFAULT 106,
  `company_latitude` double NULL DEFAULT 21.032711,
  `company_zoom` tinyint(4) NULL DEFAULT 10,
  `background_color` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '#FFFFFF',
  `text_color` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '#000000',
...
INSERT INTO `fs_members` VALUES (10, 'M000010', 'phuc', '38af9d29ed387895e9955bc65184fd25146821fa', '1930-01-01 09:00:00', 'female', 1, NULL, NULL, NULL, 0, 'phuc@gmail.com', 0, NULL, 'Bùi Văn Phúc', '0189562457', NULL, 'Nguyễn Cơ Thạch, Hà Nội', 'www.facebook.com', NULL, 'Công ty TNHH Việt Phát', '08954523541', '043245789', '043245789', 'www.vietphat.com', 'Nguyễn Cơ Thạch, Hà Nội', 105.850525, 21.032711, 10, '#FFFFFF', '#000000', NULL, '2015-12-31 09:50:52', 0, 1);
INSERT INTO `fs_members` VALUES (13, 'M000013', 'Bùi Đại Cát', '38af9d29ed387895e9955bc65184fd25146821fa', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'buidaicat@gmail.com', 0, NULL, NULL, '0989654978', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 106, 21.032711, 10, '#FFFFFF', '#000000', NULL, '2016-01-28 11:27:12', 0, 1);

-- ----------------------------
-- Table structure for fs_members_level
-- ----------------------------
DROP TABLE IF EXISTS `fs_members_level`;
...
-- ----------------------------
-- Records of fs_members_level
-- ----------------------------
INSERT INTO `fs_members_level` VALUES (1, 0, 'Thành viên thường', 0, 0, 0, NULL, 1, 0);
INSERT INTO `fs_members_level` VALUES (2, 1, 'Thành viên VIP', 1000, 1000000, 1, NULL, 1, 0);
...
CREATE TABLE `fs_menus_admin`  (
  ...
  `created_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 218 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fs_menus_admin
-- ----------------------------
INSERT INTO `fs_menus_admin` VALUES (1, 'Thành viên quản trị', 0, 1, 'backend.png', NULL, 1, 1, 1, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (2, 'User group', 1, 2, NULL, 'index.php?module=users&view=groups', 0, 0, 1, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (3, 'User', 1, 3, NULL, 'index.php?module=users&view=users', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (6, 'Menu', 0, 2, 'no-image.png', '', 1, 1, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (7, 'Menu groups', 6, 6, NULL, 'index.php?module=menus&view=groups', 0, 0, 1, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (8, 'Menus Items', 6, 8, NULL, 'index.php?module=menus&view=items', 1, 0, 1, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (13, 'Tin tức', 0, 9, 'news.png', '', 1, 1, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (14, 'Danh mục tin tức', 13, 1, NULL, 'index.php?module=news&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (15, 'Danh sách tin', 13, 2, NULL, 'index.php?module=news&view=news', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (43, 'Configuration', 0, 5, 'config.png', '', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (59, 'Contact', 0, 100, 'no-image.png', 'index.php?module=contact&view=contact', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (63, 'Thành viên', 0, 11, 'user.png', 'index.php?module=members&view=members', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (74, 'Địa điểm', 0, 12, 'no-image.png', NULL, 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (75, 'Tỉnh/Thành phố', 74, 2, NULL, 'index.php?module=location&view=cities', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (76, 'Quận/Huyện', 74, 3, NULL, 'index.php?module=location&view=districts', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (77, 'Sản phẩm', 0, 7, 'no-image.png', NULL, 0, 1, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (78, 'Danh mục sản phẩm', 77, 1, NULL, 'index.php?module=products&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (79, 'Danh sách  sản phẩm', 77, 2, NULL, 'index.php?module=products&view=products', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (80, 'Màu sắc', 77, 3, NULL, 'index.php?module=products&view=colors', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (82, 'Câu hỏi', 81, 1, NULL, 'index.php?module=poll&view=questions', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (83, 'Câu trả lời', 81, 1, NULL, 'index.php?module=poll&view=answers', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (130, 'Banner', 0, 4, NULL, NULL, 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (131, 'Danh mục banner', 130, 1, NULL, 'index.php?module=banners&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (132, 'Danh sách banner', 130, 2, NULL, 'index.php?module=banners&view=banners', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (133, 'Block', 0, 3, NULL, 'index.php?module=module&view=module', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (178, 'Danh sách dữ liệu mở rộng', 176, 2, NULL, 'index.php?module=extends&view=extends', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (177, 'Bảng dữ liệu mở rộng', 176, 1, NULL, 'index.php?module=extends&view=tables', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (163, 'Hạng thành viên', 62, 2, NULL, 'index.php?module=members&view=level', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (164, 'Đơn hàng', 0, 8, 'no-image.png', NULL, 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (165, 'Danh sách đơn hàng', 77, 5, NULL, 'index.php?module=order&view=order', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (173, 'Cấu hình chung', 43, 1, NULL, 'index.php?module=config&view=config', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (198, 'Translate phrases (font-end)', 195, 2, NULL, 'index.php?module=languages&view=text&type=fontend', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (185, 'Trang tĩnh', 0, 10, 'static.png', NULL, 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (186, 'Danh mục ', 185, 1, NULL, 'index.php?module=statics&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (187, 'Danh sách tin', 185, 1, NULL, 'index.php?module=statics&view=statics', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (197, 'Translate phrases (backend)', 195, 1, NULL, 'index.php?module=languages&view=text_admin&type=backend', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (195, 'Languages', 0, 6, NULL, NULL, 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (196, 'Translate content', 195, 3, NULL, 'index.php?module=languages&view=tables', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (199, 'Xuất xứ', 77, 4, NULL, 'index.php?module=products&view=origins', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (200, 'Mã giảm giá', 77, 6, NULL, 'index.php?module=products&view=discount', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (201, 'Lọc giá sản phẩm', 77, 5, NULL, 'index.php?module=products&view=fprice', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (202, 'Quản lý comments', 77, 3, NULL, 'index.php?module=products&view=comments', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (203, 'Xóa cache', 43, 2, NULL, 'index.php?module=config&view=config&task=delete_cache', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (204, 'Thực đơn giảm cân', 0, 8, NULL, NULL, 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (205, 'Loại thực phẩm', 204, 1, NULL, 'index.php?module=foods&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (206, 'Món ăn', 204, 1, NULL, 'index.php?module=foods&view=foods', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (207, 'Giới thiệu', 0, 9, NULL, '', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (208, 'Danh mục', 207, 1, NULL, 'index.php?module=about&view=categories', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (209, 'Danh sách', 207, 2, NULL, 'index.php?module=about&view=about', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (210, 'Videos', 0, 10, NULL, 'index.php?module=videos&view=videos', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (211, 'Dữ liệu mở rộng', 77, 9, NULL, NULL, 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (212, 'Bảng mở rộng', 211, 1, NULL, 'index.php?module=extends&view=tables', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (213, 'Dữ liệu mở rộng', 211, 2, NULL, 'index.php?module=extends&view=extends', 1, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (214, 'Định nghĩa thuộc tính, bộ lọc', 77, 10, NULL, 'index.php?module=products&view=tables', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (215, 'Quản lý comments', 13, 3, NULL, 'index.php?module=news&view=comments', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (216, 'Album ảnh', 0, 15, NULL, 'index.php?module=album&view=album', 0, 0, 0, '0000-00-00 00:00:00');
INSERT INTO `fs_menus_admin` VALUES (217, 'Download', 0, 9, NULL, 'index.php?module=download&view=download', 0, 0, 0, '0000-00-00 00:00:00');
...
CREATE TABLE `fs_menus_createlink`  (
  ...
  `add_field_distinct` tinyint(4) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fs_menus_createlink` VALUES (24, 'Trang tĩnh', 1, '0', 99, 'index.php?module=statics&view=statics', 'code,ccode,id', 'fs_statics', 'title', 'alias,category_alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (23, 'Trang chủ', 1, '0', 1, 'index.php?module=home', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (21, 'Tư vấn', 0, '19', 6, 'index.php?module=consult&view=consult', 'code,ccode', 'fs_consult', 'title', 'alias,category_alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (19, 'Tư vấn', 0, '0', 5, 'index.php?module=consult&view=home', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (20, 'Danh mục', 0, '19', 5, 'index.php?module=consult&view=cat', 'ccode,id', 'fs_consult_categories', 'name', 'alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (17, 'Sản phẩm', 0, '15', 3, 'index.php?module=product&view=product', 'code,ccode', 'fs_products', 'name', 'alias,category_alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (16, 'Danh mục', 1, '15', 2, 'index.php?module=product&view=cat', 'ccode,id', 'fs_products_categories', 'name', 'alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (15, 'Sản phẩm', 1, '0', 2, 'index.php?module=product&view=home', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (18, 'Liên hệ', 1, '0', 100, 'index.php?module=contact', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (3, 'Danh mục', 1, '1', 1, 'index.php?module=news&view=cat', 'ccode,id', 'fs_news_categories', 'name', 'alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (2, 'Bài viết', 1, '1', 2, 'index.php?module=news&view=news', 'code,ccode,id', 'fs_news', 'title', 'alias,category_alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (1, 'Tin tức', 1, '0', 3, 'index.php?module=news&view=home', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (25, 'Album ảnh', 0, '0', 7, 'index.php?module=album&view=home', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (26, 'Giới thiệu', 0, '0', 8, 'index.php?module=about&view=cat', 'ccode,id', 'fs_about_categories', 'name', 'alias,id', NULL, NULL);
INSERT INTO `fs_menus_createlink` VALUES (27, 'Bài viết', 1, '26', 16, 'index.php?module=about&view=about', 'code,ccode,id', 'fs_about', 'title', 'alias,category_alias,id', NULL, NULL);
...
-- ----------------------------
INSERT INTO `fs_menus_items` VALUES (1, 'Trang chủ', 'trang-chu', NULL, '', 0, 0, 0, '_self', 0, 1, 0, 1, '2013-02-21 08:45:29', '2013-02-21 08:45:29', NULL, NULL, '1', 0, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (2, 'Sản phẩm', 'san-pham', NULL, '', 0, 0, 0, '_self', 0, 2, 0, 0, '2013-02-21 08:45:29', '2013-02-21 08:45:29', NULL, NULL, '1', 0, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (3, 'Danh mục sản phẩm', 'danh-muc-san-pham', NULL, '', 0, 0, 0, '_self', 0, 3, 0, 0, '2013-02-21 08:45:29', '2013-02-21 08:45:29', '', NULL, '1', 0, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (4, 'Chi tiết sản phẩm', 'chi-tiet-san-pham', NULL, '', 0, 0, 0, '_self', 0, 4, 0, 0, '2013-02-21 08:45:29', '2013-02-21 08:45:29', NULL, NULL, '1', 0, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (5, 'Tin tức', 'tin-tuc', NULL, '', 0, 0, 0, '_self', 0, 5, 0, 1, '2013-02-21 08:45:29', '2013-02-21 08:45:29', NULL, NULL, '1', 0, 0, 'vi', 0);
...
INSERT INTO `fs_menus_items` VALUES (77, 'Investment', 'investment', NULL, 'index.php?module=news&view=cat&ccode=investment&id=2', 0, 0, 1, '_self', 1, 5, 0, 1, '2020-02-12 15:13:28', '2022-04-24 02:33:37', NULL, NULL, '77', 0, 0, 'vi', 0);
...
INSERT INTO `fs_menus_items` VALUES (85, 'Community', 'community', NULL, '', 0, 0, 1, '_self', 2, 16, 0, 1, '2022-04-22 21:30:28', '2022-04-22 21:30:28', NULL, NULL, '85', 0, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (86, 'About us', 'about-us', NULL, '', 82, 0, 1, '_self', 2, 17, 0, 1, '2022-04-22 21:38:04', '2022-04-22 21:38:04', NULL, NULL, '82,86', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (87, 'Careers', 'careers', NULL, '', 82, 0, 1, '_self', 2, 18, 0, 1, '2022-04-22 21:38:19', '2022-04-22 21:38:19', NULL, NULL, '82,87', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (88, 'Wallet', 'wallet', NULL, '', 83, 0, 1, '_self', 2, 19, 0, 1, '2022-04-22 21:38:37', '2022-04-22 21:38:37', NULL, NULL, '83,88', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (89, 'Exchange', 'exchange', NULL, '', 83, 0, 1, '_self', 2, 20, 0, 1, '2022-04-22 21:40:25', '2022-04-22 21:40:25', NULL, NULL, '83,89', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (90, 'Market', 'market', NULL, '', 83, 0, 1, '_self', 2, 21, 0, 1, '2022-04-22 21:40:39', '2022-04-22 21:40:39', NULL, NULL, '83,90', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (91, 'Portfolio', 'portfolio', NULL, '', 83, 0, 1, '_self', 2, 22, 0, 1, '2022-04-22 21:40:53', '2022-04-22 21:40:53', NULL, NULL, '83,91', 1, 0, 'vi', 0);
INSERT INTO `fs_menus_items` VALUES (92, 'Email', 'email', NULL, '', 84, 0, 1, '_self', 2, 23, 0, 1, '2022-04-22 21:41:06', '2022-04-22 21:41:06', NULL, NULL, '84,92', 1, 0, 'vi', 0);
...
INSERT INTO `fs_modules_admin` VALUES (4, 'Blocks', 'module', 1);
...
INSERT INTO `fs_modules_admin` VALUES (8, 'Đơn hàng', 'order', 1);
INSERT INTO `fs_modules_admin` VALUES (10, 'Languages', 'languages', 0);
...
INSERT INTO `fs_modules_admin` VALUES (16, 'Địa điểm', 'location', 1);
INSERT INTO `fs_modules_admin` VALUES (17, 'Banner', 'banners', 1);
INSERT INTO `fs_modules_admin` VALUES (18, 'Training', 'training', 0);
INSERT INTO `fs_modules_admin` VALUES (19, 'Đối tác', 'partners', 0);
INSERT INTO `fs_modules_admin` VALUES (21, 'Hỗ trợ trực tuyến', 'onlinesupport', 0);
INSERT INTO `fs_modules_admin` VALUES (22, 'Từ khóa', 'keywords', 1);
INSERT INTO `fs_modules_admin` VALUES (23, 'Trang tĩnh', 'statics', 1);
...
CREATE TABLE `fs_news`  (
  ...
  `source_website` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `new_date` int(11) NULL DEFAULT NULL,
  `created_time` datetime NULL DEFAULT NULL,
  `updated_time` datetime NULL DEFAULT NULL,
  `editor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `show_in_homepage` tinyint(4) NULL DEFAULT NULL,
...
-- Records of fs_news
-- ----------------------------
INSERT INTO `fs_news` VALUES (1, 'How to Farm Crypto and join DeFi safely?', 'How to Farm Crypto and join DeFi safely?', '', 'images/news/2022/04/original/-1650744112.png', NULL, 2, 'investment', 'Investment', ',2,', ',investment,', NULL, 'how-to-farm-crypto-and-join-defi-safely', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-24 03:01:23', '2022-04-24 03:01:53', NULL, NULL, 0, 1, 1, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
INSERT INTO `fs_news` VALUES (2, 'Evergrande and its effects on Crypto summarized in 30 sentences', 'Evergrande and its effects on Crypto summarized in 30 sentences', '', 'images/news/2022/04/original/-1650744173.png', NULL, 2, 'investment', 'Investment', ',2,', ',investment,', NULL, 'evergrande-and-its-effects-on-crypto-summarized-in-30-sentences', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-24 03:02:23', '2022-04-24 03:02:53', NULL, NULL, 0, 1, 2, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
INSERT INTO `fs_news` VALUES (3, 'Web3 Founder alpha leaks and What’s next for DeFi?', 'Web3 Founder alpha leaks and What’s next for DeFi?', '', 'images/news/2022/04/original/-1650744230.png', NULL, 2, 'investment', 'Investment', ',2,', ',investment,', NULL, 'web3-founder-alpha-leaks-and-what’s-next-for-defi', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-24 03:03:35', '2022-04-24 03:03:50', NULL, NULL, 0, 1, 3, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
INSERT INTO `fs_news` VALUES (4, 'How To Participate In DAO Maker IDO', 'How To Participate In DAO Maker IDO', '', 'images/news/2022/04/original/-1650744430.png', NULL, 1, 'make-money', 'Make money', ',1,', ',make-money,', NULL, 'how-to-participate-in-dao-maker-ido', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-23 03:06:54', '2022-04-23 03:07:10', NULL, NULL, 0, 1, 4, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
INSERT INTO `fs_news` VALUES (5, 'How to participate in an IDO on AcceleRaytor (Raydium)', 'Polkastarter is among the top-tier IDO platforms in the crypto world. In this article, Coin98 will guide you on how to participate in Polkastarter IDO.', '<p>Polkastarter is among the top-tier IDO platforms in the crypto world. It has enabled many projects to raise funds successfully. According to cryptorank.io, Polkastarter is the No.1 IDO platform by the number of funded projects (73) and AVG ATH ROI (41.17x).&nbsp;</p>\r\n\r\n<p><img alt=\"\" src=\"/uploaded/images/ido-comparision-1633912564464.jpg\" /></p>\r\n\r\n<p>As retail investors, of course, we can not miss any chance to make profits by taking part in promising IDO events. In this article, I will guide you to participate in IDO on Polkastarter step by step.</p>\r\n\r\n<h2 id=\"section-10\">Polkastarter Overview</h2>\r\n\r\n<p>As a leading launchpad, Polkastarter has enabled many projects to raise funds in a cheaper and faster way than IEO platforms. From the user&rsquo;s perspective, Polkastarter gives them the opportunities to buy tokens at a quite early stage with potentially high ROI afterward.</p>\r\n\r\n<p>The vision of Polkastarer is to be integrated into Polkadot to take advantage of the high scalability of the ecosystem. Built on Polkadot, Polkastater can leverage its cross-chain swaps, enjoying the high throughput of the native blockchain while still staying connected with other blockchains for liquidity. In the time waiting for the Polkadot&rsquo;s mainnet, Polkastarter has already run on Ethereum, Polygon, and Binance Smart Chain.&nbsp;</p>\r\n\r\n<p><img alt=\"\" src=\"/uploaded/images/polkastarter-1633912588810.jpg\" /></p>', 'images/news/2022/04/original/-1650744466.png', 'IDO,Product Walkthrough,Make Money, IDO & SHO', 3, 'airdrop', 'Airdrop', ',3,1,', ',airdrop,make-money,', NULL, 'how-to-participate-in-an-ido-on-acceleraytor-raydium', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-22 03:07:26', '2022-04-25 02:59:10', NULL, NULL, 0, 1, 5, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
INSERT INTO `fs_news` VALUES (6, 'How to participate in an IDO on Polkastarter', 'How to participate in an IDO on Polkastarter', '', 'images/news/2022/04/original/-1650782328.png', NULL, 1, 'make-money', 'Make money', ',1,', ',make-money,', NULL, 'how-to-participate-in-an-ido-on-polkastarter', 9, 'admin', 'New Moon', NULL, NULL, '2022-04-10 13:35:57', '2022-04-10 13:35:57', NULL, NULL, 0, 1, 6, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '', 'vi');
...
CREATE TABLE `fs_news_categories`  (
  ...
  `seo_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `seo_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lang` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'en',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fs_news_categories
-- ----------------------------
INSERT INTO `fs_news_categories` VALUES (1, 'Make money', 'make-money', NULL, ',make-money,', 0, ',1,', 0, 1, 1, NULL, NULL, '2022-04-24 02:32:38', '2022-04-24 02:32:38', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '', 'en');
INSERT INTO `fs_news_categories` VALUES (2, 'Investment', 'investment', NULL, ',investment,', 0, ',2,', 0, 1, 2, NULL, NULL, '2022-04-24 02:32:52', '2022-04-24 02:32:52', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '', 'en');
INSERT INTO `fs_news_categories` VALUES (3, 'Airdrop', 'airdrop', NULL, ',airdrop,make-money,', 1, ',3,1,', 1, 1, 3, NULL, NULL, '2022-04-24 02:33:07', '2022-04-24 02:33:07', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '', 'en');

-- ----------------------------
-- Table structure for fs_newsletter
-- ----------------------------
DROP TABLE IF EXISTS `fs_newsletter`;
...
-- ----------------------------
-- Records of fs_newsletter
-- ----------------------------

-- ----------------------------
-- Table structure for fs_products
-- ----------------------------
DROP TABLE IF EXISTS `fs_products`;
CREATE TABLE `fs_products`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `affiliate` enum('shopee','lazada') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `link` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `image` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `fs_products` VALUES (1, 'shopee', 'Bao cao su Okamoto 0.03 Platinum hộp 3 chiếc', 'https://shopee.vn/p-i.16751833.1708436292?deep_and_deferred=1&pid=partnerize_int&af_click_lookback=7d&is_retargeting=true&af_reengagement_window=7d&af_installpostback=false&af_sub3=&af_sub4=&af_sub2=SHOPEE&clickid=1101l7I4QT7V&af_siteid=1100l103605&utm_so', 'https://cf.shopee.vn/file/ace39ee5d98ff31bda067df35aa6db76', 89000, 110000);
INSERT INTO `fs_products` VALUES (2, 'shopee', 'Bao cao su Sagami Original 0.01 hộp 5 chiếc nhập khẩu Nhật Bản - mỏng nhất thế giới', 'https://shopee.vn/p-i.16283701.1643201333?deep_and_deferred=1&pid=partnerize_int&af_click_lookback=7d&is_retargeting=true&af_reengagement_window=7d&af_installpostback=false&af_sub3=&af_sub4=&af_sub2=SHOPEE&clickid=1011l7KJe8rJ&af_siteid=1100l103605&utm_so', 'https://cf.shopee.vn/file/080b1244f207dcc20238b62e8fb81a09', 219000, 239000);
INSERT INTO `fs_products` VALUES (3, 'shopee', 'Bao cao su sagami 0.02 cao cấp siêu mỏng - 12 chiếc', 'https://shopee.vn/p-i.16283701.1698540756?deep_and_deferred=1&pid=partnerize_int&af_click_lookback=7d&is_retargeting=true&af_reengagement_window=7d&af_installpostback=false&af_sub3=&af_sub4=&af_sub2=SHOPEE&clickid=1100l7Lbyiy4&af_siteid=1100l103605&utm_so', 'https://cf.shopee.vn/file/d2703e72efa96184ce2a743370be8b1c', 300000, 315000);
INSERT INTO `fs_products` VALUES (4, 'lazada', 'Khẩu trang chống bụi mịn PM2.5', 'https://c.lazada.vn/t/c.1Pe4?url=https%3A%2F%2Fwww.lazada.vn%2Fproducts%2Fkhau-trang-chong-bui-min-pm25-i347432385-s564252592.html&', '//vn-test-11.slatic.net/p/f0b77c0860ff8eb03847948bee16518d.jpg_340x340q80.jpg_.webp', 20000, NULL);
INSERT INTO `fs_products` VALUES (5, 'lazada', 'Giày thể thao nam TARANTO TRT-GTTN-02', 'https://www.lazada.vn/products/giay-the-thao-nam-taranto-trt-gttn-02-i202755455-s269583768.html?laz_trackid=2:mm_150581264_51753134_2010753180:clk5h33d81e23pt5g0mq55', '//vn-test-11.slatic.net/original/e8efbbe6c72f9e32718e0906bef2f1be.jpg_340x340q80.jpg_.webp', 168000, 290000);
INSERT INTO `fs_products` VALUES (6, 'lazada', 'Balo cao cấp đựng laptop 15.6 inch cả nam và nữ đều dùng được balo tích hợp cổng sạc USB sử dụng đi học đi làm đi chơi sành điệu', 'https://c.lazada.vn/t/c.1VYw?url=https%3A%2F%2Fwww.lazada.vn%2Fproducts%2Fbalo-cao-cap-dung-laptop-156-inch-ca-nam-va-nu-deu-dung-duoc-balo-tich-hop-cong-sac-usb-su-dung-di-hoc-di-lam-di-choi-sanh-dieu-i313242081-s502140643.html&', '//vn-test-11.slatic.net/p/fa12c00d38586e55759b9839c25894e6.jpg_340x340q80.jpg_.webp', 95000, 230000);
INSERT INTO `fs_products` VALUES (8, 'shopee', 'Hộp Bao cao su Durex Performa 12 cái + Tặng 1 Bao cao su Durex Performa 3 cái', 'https://shopee.vn/p-i.61792033.1037173896?deep_and_deferred=1&pid=partnerize_int&af_click_lookback=7d&is_retargeting=true&af_reengagement_window=7d&af_installpostback=false&af_sub3=&af_sub4=&af_sub2=SHOPEE&clickid=1101l7I5as8z&af_siteid=1100l103605&utm_so', 'https://cf.shopee.vn/file/22b784b23216e870f3d2f9149fa2e9a9', 194000, 216000);
INSERT INTO `fs_products` VALUES (9, 'shopee', '[CHÍNH HÃNG]COMBO 2H Bao cao su Sagami Xtreme Spearmint hương bạc hà', 'https://shopee.vn/p-i.121698453.1855798222?deep_and_deferred=1&pid=partnerize_int&af_click_lookback=7d&is_retargeting=true&af_reengagement_window=7d&af_installpostback=false&af_sub3=&af_sub4=&af_sub2=SHOPEE&clickid=1100l7LbSLQb&af_siteid=1100l103605&utm_s', 'https://cf.shopee.vn/file/7db200bc28ce378804791d32d5f3de39', 137000, 170000);
INSERT INTO `fs_products` VALUES (10, 'shopee', 'Áo Thun Unisex Tay Lỡ NY Phản Quang Đa Sắc Cực Hot', 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.112220565.2883767440', 'https://cf.shopee.vn/file/a875f5b70ac51c1cc5aafbc4d608c965', 83300, 119000);
INSERT INTO `fs_products` VALUES (11, 'shopee', 'Áo Thun Unisex Hades Phản Quang Đa Sắc', 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.194001630.6305176231', 'https://cf.shopee.vn/file/83d23b691fe38de7264b8ba667f82f57', 89000, 119000);

-- ----------------------------
-- Table structure for fs_products_categories
-- ----------------------------
DROP TABLE IF EXISTS `fs_products_categories`;
CREATE TABLE `fs_products_categories`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `level` int(11) NOT NULL DEFAULT 0,
  `parent_id` int(11) NOT NULL DEFAULT 0,
  `alias` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `root_alias` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `list_parents` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `alias_wrapper` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tablename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tags_group` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `total_products` int(11) NULL DEFAULT 0,
  `source` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `discount` double NULL DEFAULT NULL COMMENT 'Giảm giá cho list sản phẩm trong categories',
  `category_news` int(11) NULL DEFAULT 0,
  `seo_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `seo_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `seo_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lang` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'vi',
...
-- ----------------------------
-- Records of fs_products_categories
-- ----------------------------

-- ----------------------------
-- Table structure for fs_shortlink
-- ----------------------------
DROP TABLE IF EXISTS `fs_shortlink`;
CREATE TABLE `fs_shortlink`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `link` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1493 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fs_shortlink
-- ----------------------------
INSERT INTO `fs_shortlink` VALUES (1486, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.29678782.1906785904');
INSERT INTO `fs_shortlink` VALUES (1487, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.11370831.124147885');
INSERT INTO `fs_shortlink` VALUES (1488, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.16283701.1643201333');
INSERT INTO `fs_shortlink` VALUES (1489, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.16283701.1698540756');
INSERT INTO `fs_shortlink` VALUES (1490, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.16751833.1708436292');
INSERT INTO `fs_shortlink` VALUES (1491, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.61792033.1037173896');
INSERT INTO `fs_shortlink` VALUES (1492, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.121698453.1855798222');
INSERT INTO `fs_shortlink` VALUES (1493, 'https://shopee.prf.hn/click/camref:1011l9cZN/adref:/pubref:/destination:https%3A%2F%2Fshopee.vn%2Funiversal-link%2Fp-i.94287230.1550007262');

-- ----------------------------
-- Table structure for fs_sitemap
-- ----------------------------
DROP TABLE IF EXISTS `fs_sitemap`;
...
-- ----------------------------
-- Records of fs_sitemap
-- ----------------------------
INSERT INTO `fs_sitemap` VALUES (2, 'Hệ thống chất lượng', 'he-thong-chat-luong', ',he-thong-chat-luong,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'products', 'fs_products_categories', '2018-08-21 16:27:41', '2018-08-21 16:27:41', 0);
INSERT INTO `fs_sitemap` VALUES (3, 'Sản phẩm Clinker', 'san-pham-clinker', ',san-pham-clinker,', 0, ',3,', 0, 1, 3, NULL, NULL, 3, 'products', 'fs_products_categories', '2018-08-21 16:27:52', '2018-08-21 16:27:52', 0);
INSERT INTO `fs_sitemap` VALUES (5, 'Sản phẩm đá CaCO3', 'san-pham-da-caco3', ',san-pham-da-caco3,', 0, ',5,', 0, 1, 5, NULL, NULL, 5, 'products', 'fs_products_categories', '2018-08-21 16:28:14', '2018-08-21 16:28:14', 0);
INSERT INTO `fs_sitemap` VALUES (6, 'Sàn thể thao', 'san-the-thao', ',san-the-thao,', 0, ',6,', 0, 1, 6, NULL, NULL, 6, 'products', 'fs_products_categories', '2018-07-01 14:08:55', '2018-07-01 14:55:49', 0);
INSERT INTO `fs_sitemap` VALUES (7, 'Thiên Xứng', 'thien-xung', ',thien-xung,', 0, ',7,', 0, 1, 0, NULL, NULL, 7, 'products', 'fs_products_categories', '2015-02-11 14:17:01', '2015-03-19 09:14:46', 0);
INSERT INTO `fs_sitemap` VALUES (8, 'Thiên Hạt', 'thien-hat', ',thien-hat,', 0, ',8,', 0, 1, 0, NULL, NULL, 8, 'products', 'fs_products_categories', '2015-02-11 14:17:12', '2015-03-19 09:15:16', 0);
INSERT INTO `fs_sitemap` VALUES (10, 'Trợ giúp', 'tro-giup', ',tro-giup,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'statics', 'fs_statics_categories', '2015-03-03 10:58:01', '2015-03-03 10:58:01', 0);
INSERT INTO `fs_sitemap` VALUES (11, 'Hợp tác', 'hop-tac', ',hop-tac,', 0, ',3,', 0, 1, 3, NULL, NULL, 3, 'statics', 'fs_statics_categories', '2015-03-03 11:00:24', '2015-03-03 11:00:24', 0);
INSERT INTO `fs_sitemap` VALUES (13, 'Răng hàm mặt', 'rang-ham-mat', ',rang-ham-mat,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'specialist', 'fs_specialist', '2015-09-07 06:32:17', '2015-09-07 06:32:17', 0);
INSERT INTO `fs_sitemap` VALUES (14, 'Tai mũi họng', 'tai-mui-hong', ',tai-mui-hong,', 0, ',3,', 0, 1, 3, NULL, NULL, 3, 'specialist', 'fs_specialist', '2015-09-07 06:34:20', '2015-09-07 06:34:20', 0);
INSERT INTO `fs_sitemap` VALUES (16, 'Nội tổng hợp', 'noi-khoa', ',noi-khoa,', 0, ',5,', 0, 1, 5, NULL, NULL, 5, 'specialist', 'fs_specialist', '2015-09-07 06:34:38', '2015-10-16 11:55:09', 0);
INSERT INTO `fs_sitemap` VALUES (17, 'Ngoại tổng hợp', 'ngoai-tong-hop', ',ngoai-tong-hop,', 0, ',6,', 0, 1, 6, NULL, NULL, 6, 'specialist', 'fs_specialist', '2015-09-07 06:34:49', '2015-10-16 11:55:00', 0);
INSERT INTO `fs_sitemap` VALUES (18, 'Tim mạch', 'tim-mach', ',tim-mach,', 0, ',7,', 0, 1, 7, NULL, NULL, 7, 'specialist', 'fs_specialist', '2015-10-16 11:36:24', '2015-10-16 11:36:24', 0);
INSERT INTO `fs_sitemap` VALUES (19, 'Thần kinh', 'than-kinh', ',than-kinh,', 0, ',8,', 0, 1, 8, NULL, NULL, 8, 'specialist', 'fs_specialist', '2015-10-16 11:36:37', '2015-10-16 11:36:37', 0);
INSERT INTO `fs_sitemap` VALUES (20, 'Cơ xương khớp', 'co-xuong-khop', ',co-xuong-khop,', 0, ',9,', 0, 1, 9, NULL, NULL, 9, 'specialist', 'fs_specialist', '2015-10-16 11:36:48', '2015-10-16 11:36:48', 0);
INSERT INTO `fs_sitemap` VALUES (21, 'Tâm thần', 'tam-than', ',tam-than,', 0, ',10,', 0, 1, 10, NULL, NULL, 10, 'specialist', 'fs_specialist', '2015-10-16 11:36:57', '2015-10-16 11:36:57', 0);
INSERT INTO `fs_sitemap` VALUES (22, 'Phục hồi chức năng', 'phuc-hoi-chuc-nang', ',phuc-hoi-chuc-nang,', 0, ',11,', 0, 1, 11, NULL, NULL, 11, 'specialist', 'fs_specialist', '2015-10-16 11:37:06', '2015-10-16 11:37:06', 0);
INSERT INTO `fs_sitemap` VALUES (23, 'Tiêu hóa', 'tieu-hoa', ',tieu-hoa,', 0, ',12,', 0, 1, 12, NULL, NULL, 12, 'specialist', 'fs_specialist', '2015-10-16 11:38:06', '2015-10-16 11:38:06', 0);
INSERT INTO `fs_sitemap` VALUES (24, 'Thận – Tiết niệu', 'than-–-tiet-nieu', ',than-–-tiet-nieu,', 0, ',13,', 0, 1, 13, NULL, NULL, 13, 'specialist', 'fs_specialist', '2015-10-16 11:38:16', '2015-10-16 11:38:16', 0);
INSERT INTO `fs_sitemap` VALUES (25, 'Huyết học', 'huyet-hoc', ',huyet-hoc,', 0, ',14,', 0, 1, 14, NULL, NULL, 14, 'specialist', 'fs_specialist', '2015-10-16 11:38:25', '2015-10-16 11:38:25', 0);
INSERT INTO `fs_sitemap` VALUES (26, 'Hô hấp', 'ho-hap', ',ho-hap,', 0, ',15,', 0, 1, 15, NULL, NULL, 15, 'specialist', 'fs_specialist', '2015-10-16 11:38:34', '2015-10-16 11:38:34', 0);
INSERT INTO `fs_sitemap` VALUES (27, 'Truyền nhiễm', 'truyen-nhiem', ',truyen-nhiem,', 0, ',16,', 0, 1, 16, NULL, NULL, 16, 'specialist', 'fs_specialist', '2015-10-16 11:38:42', '2015-10-16 11:38:42', 0);
INSERT INTO `fs_sitemap` VALUES (41, 'Biệt thự / Penhouse Bán', 'biet-thu-penhouse-ban', ',biet-thu-penhouse-ban,', 0, ',2,', 0, 1, 3, NULL, NULL, 2, 'lands', 'fs_lands_categories', '2015-12-16 10:20:09', '2016-01-08 11:49:01', 0);
INSERT INTO `fs_sitemap` VALUES (42, 'Nhà Bán', 'nha-ban', ',nha-ban,', 0, ',3,', 0, 1, 4, NULL, NULL, 3, 'lands', 'fs_lands_categories', '2015-12-16 10:21:21', '2016-01-08 11:49:16', 0);
INSERT INTO `fs_sitemap` VALUES (44, 'Căn hộ/ Chung cư Bán', 'can-ho-chung-cu-ban', ',can-ho-chung-cu-ban,', 0, ',5,', 0, 1, 6, NULL, NULL, 5, 'lands', 'fs_lands_categories', '2015-12-16 10:21:48', '2016-01-08 11:50:11', 0);
INSERT INTO `fs_sitemap` VALUES (45, 'Kho / Xưởng bán', 'kho-xuong-ban', ',kho-xuong-ban,', 0, ',6,', 0, 1, 6, NULL, NULL, 6, 'lands', 'fs_lands_categories', '2015-12-16 10:22:06', '2015-12-24 14:03:53', 0);
INSERT INTO `fs_sitemap` VALUES (46, 'Các loại bất động sản khác', 'khac', ',khac,', 0, ',7,', 0, 1, 7, NULL, NULL, 7, 'lands', 'fs_lands_categories', '2015-12-16 10:22:19', '2015-12-24 14:04:11', 0);
INSERT INTO `fs_sitemap` VALUES (47, 'Nhà thuê', 'nha-thue', ',nha-thue,', 0, ',8,', 0, 1, 1, NULL, NULL, 8, 'lands', 'fs_lands_categories', '2015-12-16 10:25:41', '2015-12-24 14:05:29', 0);
INSERT INTO `fs_sitemap` VALUES (48, 'Phòng trọ thuê', 'nha-tro', ',nha-tro,', 0, ',9,', 0, 1, 2, NULL, NULL, 9, 'lands', 'fs_lands_categories', '2015-12-16 10:26:37', '2015-12-24 14:05:51', 0);
INSERT INTO `fs_sitemap` VALUES (49, 'Căn hộ/Chung cư thuê', 'can-hochung-cu-thue', ',can-hochung-cu-thue,', 0, ',10,', 0, 1, 3, NULL, NULL, 10, 'lands', 'fs_lands_categories', '2015-12-16 10:26:48', '2015-12-24 14:06:37', 0);
INSERT INTO `fs_sitemap` VALUES (50, 'Văn phòng thuê', 'van-phong-thue', ',van-phong-thue,', 0, ',11,', 0, 1, 4, NULL, NULL, 11, 'lands', 'fs_lands_categories', '2015-12-16 10:27:21', '2015-12-24 14:06:58', 0);
INSERT INTO `fs_sitemap` VALUES (51, 'Đất thuê', 'dat-thue', ',dat-thue,', 0, ',12,', 0, 1, 5, NULL, NULL, 12, 'lands', 'fs_lands_categories', '2015-12-16 10:27:47', '2015-12-24 14:07:25', 0);
INSERT INTO `fs_sitemap` VALUES (52, 'Khách sạn thuê', 'khach-san-thue', ',khach-san-thue,', 0, ',13,', 0, 1, 6, NULL, NULL, 13, 'lands', 'fs_lands_categories', '2015-12-16 10:28:05', '2015-12-24 14:07:46', 0);
INSERT INTO `fs_sitemap` VALUES (53, 'Kho xưởng thuê', 'kho-xuong', ',kho-xuong,', 0, ',14,', 0, 1, 7, NULL, NULL, 14, 'lands', 'fs_lands_categories', '2015-12-16 10:28:18', '2015-12-24 14:08:03', 0);
INSERT INTO `fs_sitemap` VALUES (54, 'Chọn tất cả', 'dat', ',dat,', 0, ',15,', 0, 0, 11, NULL, NULL, 15, 'lands', 'fs_lands_categories', '2015-12-16 10:28:32', '2015-12-24 14:08:25', 0);
INSERT INTO `fs_sitemap` VALUES (55, 'Các loại bất động sản khác', 'cac-loai-bat-dong-san-khac', ',cac-loai-bat-dong-san-khac,', 0, ',16,', 0, 1, 9, NULL, NULL, 16, 'lands', 'fs_lands_categories', '2015-12-16 10:28:41', '2015-12-24 14:08:48', 0);
INSERT INTO `fs_sitemap` VALUES (123, 'Investment', 'investment', ',investment,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'news', 'fs_news_categories', '2022-04-24 02:32:52', '2022-04-24 02:32:52', 0);
INSERT INTO `fs_sitemap` VALUES (76, 'Quán Cafe - Quán Nước', 'quan-cafe-quan-nuoc', ',quan-cafe-quan-nuoc,', 0, ',37,', 0, 1, 18, NULL, NULL, 37, 'lands', 'fs_lands_categories', '2015-12-24 14:12:05', '2015-12-24 14:12:05', 0);
INSERT INTO `fs_sitemap` VALUES (77, 'Nhà Hàng - Quán Ăn', 'nha-hang-quan-an', ',nha-hang-quan-an,', 0, ',38,', 0, 1, 19, NULL, NULL, 38, 'lands', 'fs_lands_categories', '2015-12-24 14:12:28', '2015-12-24 14:12:28', 0);
INSERT INTO `fs_sitemap` VALUES (78, 'Quán Bar - Quán Karaoke', 'quan-bar-quan-karaoke', ',quan-bar-quan-karaoke,', 0, ',39,', 0, 1, 20, NULL, NULL, 39, 'lands', 'fs_lands_categories', '2015-12-24 14:12:42', '2015-12-24 14:12:42', 0);
INSERT INTO `fs_sitemap` VALUES (79, 'Cửa Hàng / Shop Thời Trang', 'cua-hang-shop-thoi-trang', ',cua-hang-shop-thoi-trang,', 0, ',40,', 0, 1, 21, NULL, NULL, 40, 'lands', 'fs_lands_categories', '2015-12-24 14:12:54', '2015-12-24 14:12:54', 0);
INSERT INTO `fs_sitemap` VALUES (80, 'Spa - Thẩm Mỹ Viện', 'spa-tham-my-vien', ',spa-tham-my-vien,', 0, ',41,', 0, 1, 22, NULL, NULL, 41, 'lands', 'fs_lands_categories', '2015-12-24 14:13:04', '2015-12-24 14:13:12', 0);
INSERT INTO `fs_sitemap` VALUES (81, 'Studio / Áo Cưới', 'studio-ao-cuoi', ',studio-ao-cuoi,', 0, ',42,', 0, 1, 23, NULL, NULL, 42, 'lands', 'fs_lands_categories', '2015-12-24 14:13:31', '2015-12-24 14:13:31', 0);
INSERT INTO `fs_sitemap` VALUES (82, 'Kios - Mặt Bằng Chợ', 'kios-mat-bang-cho', ',kios-mat-bang-cho,', 0, ',43,', 0, 1, 24, NULL, NULL, 43, 'lands', 'fs_lands_categories', '2015-12-24 14:13:46', '2015-12-24 14:13:46', 0);
INSERT INTO `fs_sitemap` VALUES (83, 'Các Loại Sang Nhượng Khác', 'cac-loai-sang-nhuong-khac', ',cac-loai-sang-nhuong-khac,', 0, ',44,', 0, 1, 25, NULL, NULL, 44, 'lands', 'fs_lands_categories', '2015-12-24 14:14:01', '2015-12-24 14:14:01', 0);
INSERT INTO `fs_sitemap` VALUES (124, 'Airdrop', 'airdrop', ',airdrop,make-money,', 1, ',3,1,', 1, 1, 3, NULL, NULL, 3, 'news', 'fs_news_categories', '2022-04-24 02:33:07', '2022-04-24 02:33:07', 0);
INSERT INTO `fs_sitemap` VALUES (131, 'Câu hỏi thường gặp', 'cau-hoi-thuong-gap', ',cau-hoi-thuong-gap,', 0, ',1,', 0, 1, 1, NULL, NULL, 1, 'faqs', 'fs_faqs_categories', '2018-04-30 23:06:14', '2018-04-30 23:06:14', 0);
INSERT INTO `fs_sitemap` VALUES (93, 'Nhà Trọ Bán', 'nha-tro-ban', ',nha-tro-ban,', 0, ',54,', 0, 1, 29, NULL, NULL, 54, 'lands', 'fs_lands_categories', '2016-01-08 11:51:04', '2016-01-08 11:51:04', 0);
INSERT INTO `fs_sitemap` VALUES (94, 'Khách Sạn Bán', 'khach-san-ban', ',khach-san-ban,', 0, ',55,', 0, 1, 30, NULL, NULL, 55, 'lands', 'fs_lands_categories', '2016-01-08 11:51:25', '2016-01-08 11:51:25', 0);
INSERT INTO `fs_sitemap` VALUES (95, 'Biệt thự / Penhouse Thuê', 'biet-thu-penhouse-thue', ',biet-thu-penhouse-thue,', 0, ',56,', 0, 1, 12, NULL, NULL, 56, 'lands', 'fs_lands_categories', '2016-01-08 11:59:31', '2016-01-08 11:59:31', 0);
INSERT INTO `fs_sitemap` VALUES (96, 'Chọn tất cả', 'chon-tat-ca', ',chon-tat-ca,', 0, ',57,', 0, 0, 21, NULL, NULL, 57, 'lands', 'fs_lands_categories', '2016-01-08 12:02:11', '2016-01-08 12:02:11', 0);
INSERT INTO `fs_sitemap` VALUES (97, 'Chọn tất cả', 'chon-tat-ca', ',chon-tat-ca,', 0, ',58,', 0, 0, 30, NULL, NULL, 58, 'lands', 'fs_lands_categories', '2016-01-08 12:03:24', '2016-01-08 12:03:24', 0);
INSERT INTO `fs_sitemap` VALUES (98, 'Khu đô thị', 'khu-do-thi', ',khu-do-thi,', 0, ',59,', 0, 1, 31, NULL, NULL, 59, 'lands', 'fs_lands_categories', '2016-01-08 12:03:40', '2016-01-08 12:03:40', 0);
INSERT INTO `fs_sitemap` VALUES (99, 'Khu dân cư', 'khu-dan-cu', ',khu-dan-cu,', 0, ',60,', 0, 1, 32, NULL, NULL, 60, 'lands', 'fs_lands_categories', '2016-01-08 12:03:56', '2016-01-08 12:03:56', 0);
INSERT INTO `fs_sitemap` VALUES (100, 'Khu biệt thự', 'khu-biet-thu', ',khu-biet-thu,', 0, ',61,', 0, 1, 33, NULL, NULL, 61, 'lands', 'fs_lands_categories', '2016-01-08 12:04:08', '2016-01-08 12:04:08', 0);
INSERT INTO `fs_sitemap` VALUES (101, 'Căn hộ - Chung cư', 'can-ho-chung-cu', ',can-ho-chung-cu,', 0, ',62,', 0, 1, 34, NULL, NULL, 62, 'lands', 'fs_lands_categories', '2016-01-08 12:04:22', '2016-01-08 12:04:22', 0);
INSERT INTO `fs_sitemap` VALUES (102, 'Cao ốc - Văn phòng', 'cao-oc-van-phong', ',cao-oc-van-phong,', 0, ',63,', 0, 1, 35, NULL, NULL, 63, 'lands', 'fs_lands_categories', '2016-01-08 12:04:42', '2016-01-08 12:04:42', 0);
INSERT INTO `fs_sitemap` VALUES (103, 'Khu trung tâm thương mại', 'khu-trung-tam-thuong-mai', ',khu-trung-tam-thuong-mai,', 0, ',64,', 0, 1, 36, NULL, NULL, 64, 'lands', 'fs_lands_categories', '2016-01-08 12:04:56', '2016-01-08 12:04:56', 0);
INSERT INTO `fs_sitemap` VALUES (104, 'Khu phức hợp', 'khu-phuc-hop', ',khu-phuc-hop,', 0, ',65,', 0, 1, 37, NULL, NULL, 65, 'lands', 'fs_lands_categories', '2016-01-08 12:05:12', '2016-01-08 12:05:12', 0);
INSERT INTO `fs_sitemap` VALUES (105, 'Khu du lịch - nghỉ dưỡng', 'khu-du-lich-nghi-duong', ',khu-du-lich-nghi-duong,', 0, ',66,', 0, 1, 38, NULL, NULL, 66, 'lands', 'fs_lands_categories', '2016-01-08 12:05:29', '2016-01-08 12:05:29', 0);
INSERT INTO `fs_sitemap` VALUES (106, 'Khu công nghiệp', 'khu-cong-nghiep', ',khu-cong-nghiep,', 0, ',67,', 0, 1, 39, NULL, NULL, 67, 'lands', 'fs_lands_categories', '2016-01-08 12:05:48', '2016-01-11 15:50:21', 0);
INSERT INTO `fs_sitemap` VALUES (107, 'Môi giới', 'moi-gioi', ',moi-gioi,khach-san,', 13, ',68,13,', 1, 1, 60, NULL, NULL, 68, 'lands', 'fs_lands_categories', '2015-12-17 10:20:35', '2015-12-17 10:20:35', 0);
INSERT INTO `fs_sitemap` VALUES (108, 'Dự án', 'du-an', ',du-an,khach-san,', 13, ',69,13,', 1, 1, 61, NULL, NULL, 69, 'lands', 'fs_lands_categories', '2015-12-17 10:20:44', '2015-12-17 10:20:44', 0);
INSERT INTO `fs_sitemap` VALUES (109, 'Tất cả', 'tat-ca', ',tat-ca,kho-xuong,', 14, ',70,14,', 1, 1, 62, NULL, NULL, 70, 'lands', 'fs_lands_categories', '2015-12-17 10:20:54', '2015-12-17 10:20:54', 0);
INSERT INTO `fs_sitemap` VALUES (110, 'Chính chủ', 'chinh-chu', ',chinh-chu,kho-xuong,', 14, ',71,14,', 1, 1, 63, NULL, NULL, 71, 'lands', 'fs_lands_categories', '2015-12-17 10:21:05', '2015-12-17 10:21:05', 0);
INSERT INTO `fs_sitemap` VALUES (111, 'Môi giới', 'moi-gioi', ',moi-gioi,kho-xuong,', 14, ',72,14,', 1, 1, 64, NULL, NULL, 72, 'lands', 'fs_lands_categories', '2015-12-17 10:21:15', '2015-12-17 10:21:15', 0);
INSERT INTO `fs_sitemap` VALUES (112, 'Dự án', 'du-an', ',du-an,kho-xuong,', 14, ',73,14,', 1, 1, 65, NULL, NULL, 73, 'lands', 'fs_lands_categories', '2015-12-17 10:21:23', '2015-12-17 10:21:23', 0);
INSERT INTO `fs_sitemap` VALUES (113, 'Tất cả', 'tat-ca', ',tat-ca,dat,', 15, ',74,15,', 1, 1, 66, NULL, NULL, 74, 'lands', 'fs_lands_categories', '2015-12-17 10:21:31', '2015-12-17 10:21:31', 0);
INSERT INTO `fs_sitemap` VALUES (114, 'Chính chủ', 'chinh-chu', ',chinh-chu,dat,', 15, ',75,15,', 1, 1, 67, NULL, NULL, 75, 'lands', 'fs_lands_categories', '2015-12-17 10:21:40', '2015-12-17 10:21:40', 0);
INSERT INTO `fs_sitemap` VALUES (115, 'Môi giới', 'moi-gioi', ',moi-gioi,dat,', 15, ',76,15,', 1, 1, 68, NULL, NULL, 76, 'lands', 'fs_lands_categories', '2015-12-17 10:21:49', '2015-12-17 10:21:49', 0);
INSERT INTO `fs_sitemap` VALUES (116, 'Dự án', 'du-an', ',du-an,dat,', 15, ',77,15,', 1, 1, 69, NULL, NULL, 77, 'lands', 'fs_lands_categories', '2015-12-17 10:21:58', '2015-12-17 10:21:58', 0);
INSERT INTO `fs_sitemap` VALUES (117, 'Tất cả', 'tat-ca', ',tat-ca,khac,', 16, ',78,16,', 1, 1, 70, NULL, NULL, 78, 'lands', 'fs_lands_categories', '2015-12-17 10:22:05', '2015-12-17 10:22:05', 0);
INSERT INTO `fs_sitemap` VALUES (118, 'Chính chủ', 'chinh-chu', ',chinh-chu,khac,', 16, ',79,16,', 1, 1, 71, NULL, NULL, 79, 'lands', 'fs_lands_categories', '2015-12-17 10:22:13', '2015-12-17 10:22:13', 0);
INSERT INTO `fs_sitemap` VALUES (119, 'Môi giới', 'moi-gioi', ',moi-gioi,khac,', 16, ',80,16,', 1, 1, 72, NULL, NULL, 80, 'lands', 'fs_lands_categories', '2015-12-17 10:22:22', '2015-12-17 10:22:22', 0);
INSERT INTO `fs_sitemap` VALUES (120, 'Dự án', 'du-an', ',du-an,khac,', 16, ',81,16,', 1, 1, 73, NULL, NULL, 81, 'lands', 'fs_lands_categories', '2015-12-17 10:22:30', '2015-12-17 10:22:30', 0);
INSERT INTO `fs_sitemap` VALUES (127, 'App dành cho website', 'app-danh-cho-website', ',app-danh-cho-website,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'customers', 'fs_customers_categories', '2018-03-04 23:30:36', '2018-03-04 23:30:36', 0);
INSERT INTO `fs_sitemap` VALUES (128, 'App quản lý nội bộ', 'app-quan-ly-noi-bo', ',app-quan-ly-noi-bo,', 0, ',3,', 0, 1, 3, NULL, NULL, 3, 'customers', 'fs_customers_categories', '2018-03-04 23:30:50', '2018-03-04 23:30:50', 0);
INSERT INTO `fs_sitemap` VALUES (130, 'Make money', 'make-money', ',make-money,', 0, ',1,', 0, 1, 1, NULL, NULL, 1, 'news', 'fs_news_categories', '2022-04-24 02:32:38', '2022-04-24 02:32:38', 0);
INSERT INTO `fs_sitemap` VALUES (132, 'Trình độ công nghệ', 'trinh-do-cong-nghe', ',trinh-do-cong-nghe,', 0, ',1,', 0, 1, 1, NULL, NULL, 1, 'products', 'fs_products_categories', '2018-08-21 16:27:05', '2018-09-13 10:03:09', 0);
INSERT INTO `fs_sitemap` VALUES (133, 'Sản phẩm xi măng', 'san-pham-xi-mang', ',san-pham-xi-mang,', 0, ',4,', 0, 1, 4, NULL, NULL, 4, 'products', 'fs_products_categories', '2018-08-21 16:28:06', '2018-08-21 16:28:06', 0);
INSERT INTO `fs_sitemap` VALUES (134, 'Thông tin giới thiệu', 'gioi-thieu', ',gioi-thieu,', 0, ',1,', 0, 1, 1, NULL, NULL, 1, 'about', 'fs_about_categories', '2018-08-18 15:38:12', '2018-09-13 14:42:29', 0);
INSERT INTO `fs_sitemap` VALUES (135, 'Album ảnh', 'album-anh', ',album-anh,', 0, ',1,', 0, 1, 1, NULL, NULL, 1, 'album', 'fs_album_categories', '2018-08-27 12:01:31', '2018-08-27 12:01:31', 0);
INSERT INTO `fs_sitemap` VALUES (136, 'Dự án', 'du-an', ',du-an,', 0, ',2,', 0, 1, 2, NULL, NULL, 2, 'about', 'fs_about_categories', '2018-09-13 14:36:13', '2018-09-13 14:36:13', 0);
INSERT INTO `fs_sitemap` VALUES (137, 'Bản cáo bạch', 'ban-cao-bach', ',ban-cao-bach,', 0, ',3,', 0, 1, 3, NULL, NULL, 3, 'about', 'fs_about_categories', '2018-09-13 14:54:31', '2018-09-13 14:54:31', 0);
INSERT INTO `fs_sitemap` VALUES (138, 'Phân phối', 'phan-phoi', ',phan-phoi,', 0, ',4,', 0, 1, 4, NULL, NULL, 4, 'about', 'fs_about_categories', '2018-09-13 14:59:23', '2018-09-13 14:59:23', 0);
INSERT INTO `fs_sitemap` VALUES (139, 'Làm đẹp', 'lam-dep', ',lam-dep,', 0, ',4,', 0, 1, 4, NULL, NULL, 4, 'news', 'fs_news_categories', '2020-02-12 14:51:04', '2020-02-14 21:22:27', 0);
INSERT INTO `fs_sitemap` VALUES (140, 'Du lịch', 'du-lich', ',du-lich,', 0, ',5,', 0, 1, 5, NULL, NULL, 5, 'news', 'fs_news_categories', '2020-02-12 14:53:23', '2020-02-14 21:11:00', 0);
INSERT INTO `fs_sitemap` VALUES (141, 'Giải trí', 'giai-tri', ',giai-tri,', 0, ',6,', 0, 1, 6, NULL, NULL, 6, 'news', 'fs_news_categories', '2020-02-12 14:55:03', '2020-02-14 21:23:43', 0);
INSERT INTO `fs_sitemap` VALUES (142, 'Xe cộ', 'xe-co', ',xe-co,', 0, ',7,', 0, 1, 7, NULL, NULL, 7, 'news', 'fs_news_categories', '2020-02-12 14:56:37', '2020-02-14 21:16:51', 0);
INSERT INTO `fs_sitemap` VALUES (143, 'Kiến thức', 'kien-thuc', ',kien-thuc,', 0, ',8,', 0, 1, 9, NULL, NULL, 8, 'news', 'fs_news_categories', '2020-02-14 21:28:37', '2020-02-14 21:28:37', 0);

-- ----------------------------
-- Table structure for fs_statics
-- ----------------------------
DROP TABLE IF EXISTS `fs_statics`;
...
-- ----------------------------
-- Records of fs_statics
-- ----------------------------
INSERT INTO `fs_statics` VALUES (1, 'Mọi dịch vụ thiết kế App của chúng tôi đều được bảo trì dài hạn, uy tín và cam kết tới tất cả mọi khách hàng', '', NULL, 1, 'gioi-thieu', 'Giới thiệu', ',1,', ',gioi-thieu,', 'Bảo trì dài hạn', 'bao-tri-dai-han', 'images/statics/2018/02/21/original/bao-tri-dai-han-1519232336.png', NULL, NULL, '2018-02-21 23:58:56', '2018-02-22 00:23:33', NULL, NULL, 0, 1, 1, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '');
INSERT INTO `fs_statics` VALUES (2, 'Với nhiều kỹ sư IT và chuyên viên đồ họa kinh nghiệm lâu năm đem lại sản phẩm tối ưu và giải pháp hoàn thiện nhất.', '', NULL, 1, 'gioi-thieu', 'Giới thiệu', ',1,', ',gioi-thieu,', 'Dịch vụ chuyên nghiệp', 'dich-vu-chuyen-nghiep', 'images/statics/2018/02/22/original/dich-vu-chuyen-nghiep-1519232855.png', NULL, NULL, '2018-02-22 00:07:35', '2018-02-22 00:23:36', NULL, NULL, 0, 1, 2, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '');
INSERT INTO `fs_statics` VALUES (3, 'Finalstyle cung cấp dịch vụ thiết kế App theo yêu cầu riêng cho từng đối tượng khách hàng, lĩnh vực khác nhau.', '', NULL, 1, 'gioi-thieu', 'Giới thiệu', ',1,', ',gioi-thieu,', 'Thiết kế riêng biệt', 'thiet-ke-rieng-biet', 'images/statics/2018/02/22/original/thiet-ke-rieng-biet-1519232980.png', NULL, NULL, '2018-02-22 00:09:40', '2018-02-22 00:23:39', NULL, NULL, 0, 1, 3, NULL, 1, 0, NULL, 0, 0, '', 0, '', '', '');

-- ----------------------------
-- Table structure for fs_statics_categories
-- ----------------------------
DROP TABLE IF EXISTS `fs_statics_categories`;
...
-- ----------------------------
-- Records of fs_statics_categories
-- ----------------------------
INSERT INTO `fs_statics_categories` VALUES (1, 'Giới thiệu', 'gioi-thieu', NULL, ',gioi-thieu,', 0, ',1,', 0, 1, 1, NULL, NULL, '2018-02-21 23:38:36', '2018-02-21 23:38:36', 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, '', '', '', 'vi');

-- ----------------------------
-- Table structure for fs_stories
-- ----------------------------
DROP TABLE IF EXISTS `fs_stories`;
...
-- ----------------------------
-- Records of fs_stories_categories
-- ----------------------------
INSERT INTO `fs_stories_categories` VALUES (1, 'Yêu', 'yeu', NULL, ',yeu,', 0, '.1.', 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', 'https://www.truyenngan.com.vn/truyen-ngan/truyen-ngan-yeu/', 102);
INSERT INTO `fs_stories_categories` VALUES (2, 'Bạn', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', NULL, 0);
INSERT INTO `fs_stories_categories` VALUES (3, 'Sống', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', NULL, 0);
INSERT INTO `fs_stories_categories` VALUES (4, 'Gia đình', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', NULL, 0);
INSERT INTO `fs_stories_categories` VALUES (5, 'Tản mạn', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', NULL, 0);
INSERT INTO `fs_stories_categories` VALUES (6, 'Kinh dị', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1, 1, 1, 1, 1, '', 0, 0, NULL, NULL, NULL, 'en', NULL, 0);

-- ----------------------------
-- Table structure for fs_tables
-- ----------------------------
DROP TABLE IF EXISTS `fs_tables`;
CREATE TABLE `fs_tables`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `field_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `field_alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `field_name_display` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `field_type` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `field_length` int(11) NULL DEFAULT NULL,
  `foreign_id` int(11) NULL DEFAULT NULL,
  `foreign_name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foreign_tablename` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `ordering` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `fs_users`  (
  ...
  `nums_visit` int(11) NULL DEFAULT NULL,
  `status_online` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of fs_users
-- ----------------------------
INSERT INTO `fs_users` VALUES (9, 'admin', 'd41d8cd98f00b204e9800998ecf8427e', 'New Moon', NULL, '', '', 'admin@ybcmjsc.com.vn', '', 'Ha Noi', 'Việt Nam', 1, 1, '2010-09-18 03:33:51', '2022-04-24 07:04:33', NULL, NULL, NULL);
...
CREATE TABLE `fs_users_groups`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 128 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Fixed;
...
INSERT INTO `fs_users_groups` VALUES (127, 9, 1);
INSERT INTO `fs_users_groups` VALUES (51, 12, 1);
INSERT INTO `fs_users_groups` VALUES (56, 13, 1);
INSERT INTO `fs_users_groups` VALUES (60, 16, 1);
INSERT INTO `fs_users_groups` VALUES (70, 20, 1);
INSERT INTO `fs_users_groups` VALUES (78, 23, 1);
INSERT INTO `fs_users_groups` VALUES (81, 24, 1);
INSERT INTO `fs_users_groups` VALUES (111, 26, 1);
INSERT INTO `fs_users_groups` VALUES (85, 27, 1);
INSERT INTO `fs_users_groups` VALUES (125, 29, 1);
INSERT INTO `fs_users_groups` VALUES (100, 33, 1);
INSERT INTO `fs_users_groups` VALUES (119, 36, 1);
INSERT INTO `fs_users_groups` VALUES (107, 38, 1);
INSERT INTO `fs_users_groups` VALUES (118, 39, 1);
INSERT INTO `fs_users_groups` VALUES (120, 40, 1);

-- ----------------------------
-- Table structure for fs_users_online
-- ----------------------------
DROP TABLE IF EXISTS `fs_users_online`;
CREATE TABLE `fs_users_online`  (
  `au_session_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `au_last_visit` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`au_session_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fs_users_online
-- ----------------------------
INSERT INTO `fs_users_online` VALUES ('1hfeun4dstb55nogauna4gv2e4', 1387161565);
INSERT INTO `fs_users_online` VALUES ('ncbejp897f4q0b1tl66b2i2707', 1387160871);
INSERT INTO `fs_users_online` VALUES ('j8a76n2qj4cabel66vvn7o9110', 1387161107);
INSERT INTO `fs_users_online` VALUES ('pgd3nb1sqj4amqsodbo5li1556', 1387161509);
INSERT INTO `fs_users_online` VALUES ('vf8hn7ltfctisi50af72lhodo1', 1387161008);
INSERT INTO `fs_users_online` VALUES ('p9lo5f72sbv2eduhrfhs72ldv1', 1387161557);
INSERT INTO `fs_users_online` VALUES ('0tjp5qmnj0lnrhkp3ebmoa7je5', 1387161476);
INSERT INTO `fs_users_online` VALUES ('igcl759cqrhsknus85chn5m300', 1387161379);
INSERT INTO `fs_users_online` VALUES ('o0k3p346orvm0jfgrktf5ivtf0', 1387161450);
INSERT INTO `fs_users_online` VALUES ('p6uko6gte4p9l9ent4v3n3avd0', 1387161537);
INSERT INTO `fs_users_online` VALUES ('bh4gr6ib23eiod8giru2p8pmu6', 1387161517);

-- ----------------------------
-- Table structure for fs_visited
-- ----------------------------
DROP TABLE IF EXISTS `fs_visited`;
...
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Den so lan truy cap' ROW_FORMAT = FIXED;

-- ----------------------------
-- Records of fs_visited
-- ----------------------------
INSERT INTO `fs_visited` VALUES (1, 591004);
