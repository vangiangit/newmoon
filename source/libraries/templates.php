...
class Templates{
    ...
    function loadHeader(){
        ...
        echo '    <title>'.htmlspecialchars_decode($this->title).'</title>'."\n";
        echo '    <meta name="keywords" content="'.htmlspecialchars_decode($this->head_meta_key).'" />'."\n";
        echo '    <meta name="description" content="'.htmlspecialchars_decode($this->head_meta_des).'" />'."\n"; 
