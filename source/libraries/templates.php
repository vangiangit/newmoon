...
class Templates{
    ...
    function loadHeader(){
        ...
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            ...
            })(window,document,'script','dataLayer','GTM-K6V8HVB');</script>
        <!-- End Google Tag Manager -->
        <script data-ad-client="ca-pub-7712580871996538" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        <?php
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K6V8HVB"
