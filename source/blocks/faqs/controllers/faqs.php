 ...
 */ 
require_once(PATH_BASE.'blocks/faqs/models/faqs.php');
class FaqsBControllersFaqs{
    function display($parameters, $title, $blockId = 0){
        $Itemid = 4;
        $style = $parameters->getParams('style');
        $style = $style ? $style : 'default';
        
        $model = new FaqsBModelsFaqs();
        ...
        $bLink = FSRoute::_('index.php?module=faqs&view=home&Itemid='.$Itemid);
        ...
        require(PATH_BASE.'blocks/faqs/views/'.$style.'.php');
    }
}