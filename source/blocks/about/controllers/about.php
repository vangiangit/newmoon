 ...
 */ 
require_once(PATH_BASE.'blocks/about/models/about.php');
class AboutBControllersAbout{
    function display($parameters, $title, $blockId = 0){
        $Itemid = 6;
        $style = $parameters->getParams('style');
        $style = $style ? $style : 'default';
        
        $model = new AboutBModelsAbout();
        ...
        require(PATH_BASE.'blocks/about/views/'.$style.'.php');
    }
}