			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using the <a href="http://finalstyle.com" title="Google Sitemap Generator">Google Sitemap Generator</a> by <a href="http://finalstyle.com/">FinalStyle</a>.<br />
				...
				<div id="footer">
					Generated with <a href="http://finalstyle.com" title="Google Sitemap Generator">Google Sitemap Generator</a> by <a href="http://finalstyle.com/">FinalStyle</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
